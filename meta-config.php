 ...
 * Titles and descriptions include "open source" as a trust/differentiator signal.
 * Titles: 55–70 chars. Descriptions: 145–165 chars.
 * Primary keywords placed early, CTR-optimized content.
 */
return [
    // ============================================
    // CORE PAGES
    // ============================================
    'index.php' => [
        'title' => 'Free Open Source Keyboard Tester — Ghosting, Heatmap & N-Key Rollover',
        // 71 chars
        'description' => 'Press any key and watch it highlight instantly. Free open source keyboard tester detects stuck keys, ghosting, and N-key rollover. Works on Chrome, Firefox, and Edge. No download or sign-up.',
        'keywords' => 'keyboard tester, open source keyboard tester, online keyboard test, test keyboard keys, free key tester, stuck key detector',
        'og_image' => 'images/keyboard/hero-keyboard-test-1400.png'
    ],
    'about-us.php' => [
        'title' => 'About Us — Free Open Source Testing Tools | KeyboardTester.Click',
        // 66 chars
    ...
    'tools.php' => [
        ...
        // 58 chars
        'description' => 'Explore all free open source testing tools: keyboard tester, mouse tester, webcam test, mic test, screen test, typing speed, gamepad tester, and more. No download needed.',
        'keywords' => 'free open source testing tools, keyboard tester, mouse tester, device testing online'
    ],
    ...
    'keyboard_typing_test.php' => [
        'title' => 'Free Open Source Typing Speed Test — WPM Test Online',
        // 53 chars
    ...
    'keyboard_tester_arabic.php' => [
        'title' => 'Free Open Source Arabic Keyboard Tester — Test Keys Online',
        // 59 chars
    ...
    'keyboard_tester_french.php' => [
        'title' => 'Free Open Source French Keyboard Tester — AZERTY Layout',
        // 56 chars
    ...
    'keyboard_tester_german.php' => [
        'title' => 'Free Open Source German Keyboard Tester — QWERTZ Layout',
        // 56 chars
    ...
    'keyboard_tester_spanish.php' => [
        'title' => 'Free Open Source Spanish Keyboard Tester — Test Keys Online',
        // 60 chars
    ...
    'keyboard_tester_portuguese.php' => [
        'title' => 'Free Open Source Portuguese Keyboard Tester — PT Layout',
        // 56 chars
    ...
    'keyboard_tester_russian.php' => [
        'title' => 'Free Open Source Russian Keyboard Tester — Cyrillic Keys',
        // 57 chars
    ...
    'keyboard_tester_japanese.php' => [
        'title' => 'Free Open Source Japanese Keyboard Tester — JIS Layout',
        // 55 chars
    ...
    'keyboard_tester_korean_index.php' => [
        'title' => 'Free Open Source Korean Keyboard Tester — Hangul Keys',
        // 54 chars
    ...
    'keyboard_tester_different_languages.php' => [
        'title' => 'Free Open Source Multi-Language Keyboard Tester — All Layouts',
        // 62 chars
    ...
    // ============================================
    'mouse-test.php' => [
        'title' => 'Free Open Source Mouse Tester — Click & Scroll Test Online',
        // 59 chars
        'description' => 'Free open source mouse tester to check all buttons and scroll wheel. Test left, right, and middle click instantly in your browser. Works with any USB or wireless mouse. No download needed.',
    ...
    'mouse_speed_tester.php' => [
        'title' => 'Free Open Source Click Speed Test — CPS Test Online',
        // 52 chars
        'description' => 'Free open source click speed test to measure clicks per second (CPS). Test your clicking speed with timed challenges. No download required. Track your best score.',
    ...
    'mouse-trail.php' => [
        'title' => 'Free Open Source Mouse Trail Test — Track Cursor Movement',
        // 57 chars
    ...
    // ============================================
    'mic-tester.php' => [
        'title' => 'Free Open Source Microphone Tester — Mic Test Online',
        // 53 chars
        'description' => 'Free open source microphone tester to check audio quality and volume levels. Record and playback samples instantly. No download required. Works on all devices.',
    ...
    'headphone_speaker_tester_index.php' => [
        'title' => 'Free Open Source Headphone & Speaker Tester Online',
        // 51 chars
    ...
    'webcamtesterindex.php' => [
        'title' => 'Free Open Source Webcam Tester — Camera Test Online',
        // 52 chars
        'description' => 'Free open source webcam tester to check video quality and camera functionality. Take test snapshots before meetings. No download required. Works instantly in your browser.',
    ...
    'backlight-bleed-test.php' => [
        'title' => 'Free Open Source Backlight Bleed Test — Monitor Light Leak Check Online',
        // 72 chars
    ...
    'screentestindex.php' => [
        'title' => 'Free Open Source Screen Tester — Dead Pixel Test Online',
        // 55 chars
        ...
        'keywords' => 'screen tester, open source dead pixel test, monitor test, pixel test, display test online',
    ...
    'auto-password-generator.php' => [
        'title' => 'Free Open Source Password Generator — Secure Passwords Online',
        // 62 chars
    ...
    'ocr-tool.php' => [
        'title' => 'Free Open Source OCR Tool — Extract Text From Images Online',
        // 59 chars
    ...
    'QR_code_generator_scanner.php' => [
        'title' => 'Free Open Source QR Code Generator — Create QR Codes Online',
        // 60 chars
    ...
    'qr-code-reader.php' => [
        'title' => 'Free Open Source QR Code Reader — Scan QR Codes Online',
        // 55 chars
    ...
    'whatsapp-link-generator.php' => [
        'title' => 'Free Open Source WhatsApp Link Generator — Create Chat Links',
        // 61 chars
    ...
    'whatsapp-Brand-link-generator.php' => [
        'title' => 'Free Open Source WhatsApp QR Generator — Business Chat QR',
        // 58 chars
    ...
    'whatsapp-sentiment-analyzer.php' => [
        'title' => 'Free Open Source WhatsApp Sentiment Analyzer — Chat Analysis',
        // 61 chars
        'description' => 'Free open source WhatsApp sentiment analyzer to understand message tone and emotion. Analyze exported chat conversations locally in your browser. No data uploaded. Privacy-first tool.',
        'keywords' => 'WhatsApp sentiment analyzer, open source chat analysis, message tone analyzer, conversation sentiment',
    ...
    'polling-rate-test.php' => [
        'title' => 'Free Open Source Mouse Polling Rate Test — Check Mouse Hz Online',
        // 65 chars
    ...
    'refresh-rate-test.php' => [
        'title' => 'Free Open Source Monitor Refresh Rate Test — Check Hz Online',
        // 61 chars
    ...
    'touch-screen-test.php' => [
        'title' => 'Free Open Source Touch Screen Test — Multi-Touch & Ghost Touch Online',
        // 69 chars
    ...
    'gamepad-test.php' => [
        'title' => 'Free Open Source Gamepad Tester — Controller Buttons & Drift Online',
        // 68 chars
    ...
    'color-test.php' => [
        'title' => 'Free Open Source Monitor Color Test — Screen Color Check Online',
        // 63 chars
    ...
    // ============================================
    'spacebar-test.php' => [
        'title' => 'Free Open Source Spacebar Test — Spacebar Counter Online',
        // 57 chars
    ...
    'reaction-time-test.php' => [
        'title' => 'Free Open Source Reaction Time Test — Click When Green Online',
        // 61 chars
    ...
    'dead-pixel-test.php' => [
        'title' => 'Free Open Source Dead Pixel Test — Check Your Screen Online',
        // 59 chars
    ...
    'stuck-pixel-test.php' => [
        'title' => 'Free Open Source Stuck Pixel Test — Fix Stuck Pixels Online',
        // 60 chars
    ...
    'keyboard-ghosting-test.php' => [
        'title' => 'Free Open Source Keyboard Ghosting Test — Anti-Ghosting Check Online',
        // 68 chars
    ...
    'n-key-rollover-test.php' => [
        'title' => 'Free Open Source N-Key Rollover Test — Check NKRO Online',
        // 57 chars
    ...
    'stuck-key-test.php' => [
        'title' => 'Free Open Source Stuck Key Test — Check Jammed Keyboard Keys',
        // 61 chars
    ...
    'scroll-wheel-test.php' => [
        'title' => 'Free Open Source Scroll Wheel Test — Check Mouse Scroll Online',
        // 62 chars
    ...
    'black-screen-test.php' => [
        'title' => 'Free Open Source Black Screen Test — Monitor Black Level Check',
        // 62 chars
    ...
    'white-screen-test.php' => [
        'title' => 'Free Open Source White Screen Test — Bright Screen & Dead Pixel Check',
        // 70 chars
    ...
    'camera-resolution-test.php' => [
        'title' => 'Free Open Source Camera Resolution Test — Webcam Quality Check',
        // 63 chars
    ...
    'scan-qr-from-image.php' => [
        'title' => 'Free Open Source QR Code Scanner — Scan QR From Image Online',
        // 61 chars
    ...
    'screenshot-to-text.php' => [
        'title' => 'Free Open Source Screenshot to Text — OCR Image Converter Online',
        // 65 chars
    ...
    'photo-to-text.php' => [
        'title' => 'Free Open Source Photo to Text — Extract Text From Image Online',
        // 63 chars
    ...
    'test-my-mic.php' => [
        'title' => 'Free Open Source Mic Test — Test Your Microphone Online',
        // 55 chars
    ...
    'webcam-not-working-test.php' => [
        'title' => 'Free Open Source Webcam Not Working Test — Fix Camera Online',
        // 61 chars
    ...
    'left-right-speaker-test.php' => [
        'title' => 'Free Open Source Left Right Speaker Test — Audio Channel Check',
        // 62 chars
    ...
    'stereo-test.php' => [
        'title' => 'Free Open Source Stereo Test — Check Stereo Audio Channels Online',
        // 65 chars
    ...
    'microphone-volume-test.php' => [
        'title' => 'Free Open Source Microphone Volume Test — Check Mic Level Online',
        // 65 chars
    ...
    'take-picture-with-webcam.php' => [
        'title' => 'Free Open Source Take Picture With Webcam — Webcam Photo Tool',
        // 62 chars
    ...
    'key-repeat-rate-test.php' => [
        'title' => 'Key Repeat Rate & Delay Tester — Check Your Keyboard Repeat Speed Online | KeyboardTester.click',
    ...
    'typing-rhythm-test.php' => [
        'title' => 'Typing Rhythm Fingerprint — Visualize Your Keystroke Timing Patterns Online | KeyboardTester.click',
    ...
    'keyboard-sound-test.php' => [
        'title' => 'Keyboard Switch Sound Analyzer — Test If Your Keys Are Linear, Tactile or Clicky | KeyboardTester.click',
    ...
    'luckywheeltoolindex.php' => [
        'title' => 'Free Open Source Lucky Wheel Spinner — Random Picker Online',
        // 59 chars
