...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    <?php include 'help/brief-whatsapp-link-generator.php'; ?>
    ...
    <section class="trust-strip" aria-label="Key benefits">
      <div class="container trust-grid">
        ...
        <div class="trust-item">
          ...
          <div class="trust-desc">Built for WhatsApp link</div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="landing-feature-grid">
          <article class="landing-feature-card">
            ...
            <p>Track WhatsApp link with live updates.</p>
          </article>
          <article class="landing-feature-card">
        ...
        <div class="process-grid">
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/whatsapp-link/step-1.svg'); ?>" alt="Start the test" loading="lazy">
            </div>
          ...
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/whatsapp-link/step-2.svg'); ?>" alt="Enter phone and message" loading="lazy">
            </div>
          ...
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/whatsapp-link/step-3.svg'); ?>" alt="Review results" loading="lazy">
            </div>
            <div class="step-number">03</div>
            <h3>Review results</h3>
            <p>Check your WhatsApp link stats and retest if needed.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section class="tool-stage" aria-labelledby="tool-stage-title">
      <div class="container tool-stage-header">
        <div>
          ...
          <h2 id="tool-stage-title">WhatsApp Link Generator</h2>
      ...
      <section id="whatsapp-link-generator" class="tool-shell">
        <?php include 'tools/whatsapp_link_generator_tool.php'; ?>
      </section>
    </section>
