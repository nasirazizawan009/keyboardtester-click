...
$copy = [
    ...
    'korean' => [
        'title' => '검색 엔진이 더 잘 찾는 집중 페이지',
        'intro' => '화면, 마이크, 카메라, QR 특화 페이지로의 직접 링크가 언어 허브에서의 내부 연결을 강화합니다.',
    ],
    'portuguese' => [
    ...
    'russian' => [
        'title' => 'Важные страницы для быстрого обнаружения',
        'intro' => 'Прямые ссылки на страницы экрана, микрофона, камеры и QR усиливают внутреннюю перелинковку из языкового хаба.',
    ],
    'spanish' => [
