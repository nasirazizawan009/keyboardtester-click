...
$langData = [
  'es' => [
    ...
    'description'        => 'Prueba de pantalla táctil online: detecta zonas muertas, toques fantasma y problemas del digitizador. Ideal para tablets, phones y laptops táctiles, sin instalación.',
  ...
  'fr' => [
    ...
    'description'        => 'Test d\'écran tactile en ligne : détecte zones mortes, touches fantômes et problèmes de digitizer. Idéal pour tablettes, téléphones et ordinateurs tactiles, sans installation.',
  ...
  'de' => [
    ...
    'description'        => 'Touchscreen-Test online: Erkennt tote Zonen, Geistertasten und Digitizer-Probleme. Ideal für Tablets, Smartphones und Touch-Laptops, im Browser ohne Installation.',
    'h1'                 => 'Touchscreen-Test',
  ...
  'pt' => [
    ...
    'description'        => 'Teste de tela sensível ao toque online: detecta zonas mortas, toques fantasma e problemas de digitalizador. Ideal para tablets, celulares e laptops com touch.',
  ...
  'ru' => [
    ...
    'description'        => 'Онлайн-тест сенсорного экрана: выявляет мёртвые зоны, фантомные касания и проблемы дигитайзера. Идеально для планшетов, телефонов и тач-ноутбуков, без установки.',
  ...
  'ar' => [
    ...
    'description'        => 'اختبار الشاشة اللمسية عبر الإنترنت: يكتشف المناطق الميتة واللمس الوهمي ومشاكل المحوّل الرقمي. مثالي للأجهزة اللوحية والهواتف والحواسيب اللمسية، بدون تثبيت.',
