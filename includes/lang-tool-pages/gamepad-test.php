...
$langData = [
  'es' => [
    ...
    'description'        => 'Probador de gamepad online: prueba botones, joysticks, gatillos y vibración de mandos Xbox, PS, Switch y genéricos. Compatible con Gamepad API, sin instalación.',
  ...
  'fr' => [
    ...
    'description'        => 'Testeur de manette en ligne : testez boutons, joysticks, gâchettes et vibration des manettes Xbox, PS, Switch et génériques. Compatible Gamepad API, sans installation.',
    'h1'                 => 'Test de Manette',
  ...
  'de' => [
    ...
    'description'        => 'Online-Gamepad-Tester: Testet Buttons, Joysticks, Trigger und Vibration von Xbox-, PS-, Switch- und generischen Controllern. Gamepad-API-kompatibel, ohne Installation.',
    'h1'                 => 'Gamepad-Tester',
  ...
  'pt' => [
    ...
    'description'        => 'Testador de gamepad online: teste botões, joysticks, gatilhos e vibração de controles Xbox, PS, Switch e genéricos. Compatível com Gamepad API, sem instalação.',
  ...
  'ru' => [
    ...
    'description'        => 'Онлайн-тестер геймпада: тестируйте кнопки, стики, триггеры и вибрацию контроллеров Xbox, PS, Switch и универсальных. Совместимо с Gamepad API, без установки.',
  ...
  'ar' => [
    ...
    'description'        => 'أداة اختبار وحدة التحكم عبر الإنترنت: اختبر الأزرار والعصا والزناد والاهتزاز في وحدات Xbox وPS وSwitch والعامة. متوافق مع Gamepad API، بدون تثبيت.',
