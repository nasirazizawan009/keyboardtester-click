...
$langData = [
  'es' => [
    ...
    'description'      => 'Prueba de frecuencia de actualización del monitor: detecta tu refresh rate real (60, 120, 144, 165, 240 Hz) mediante medición precisa del tiempo entre frames.',
  ...
  'fr' => [
    ...
    'description'      => 'Test de fréquence de rafraîchissement écran : détecte votre refresh rate réel (60, 120, 144, 165, 240 Hz) par mesure précise du temps entre images. Sans installation, instantané.',
  ...
  'de' => [
    ...
    'description'      => 'Monitor-Bildwiederholraten-Test: Erkennt Ihre tatsächliche Refresh Rate (60, 120, 144, 165, 240 Hz) durch präzise Frame-Zeit-Messung. Ohne Installation, sofort im Browser.',
  ...
  'pt' => [
    ...
    'description'      => 'Teste de taxa de atualização do monitor: detecta seu refresh rate real (60, 120, 144, 165, 240 Hz) por medição precisa do tempo entre quadros. Sem instalação, instantâneo.',
  ...
  'ru' => [
    ...
    'description'      => 'Тест частоты обновления монитора: определяет реальный refresh rate (60, 120, 144, 165, 240 Гц) через точное измерение времени между кадрами. Без установки, мгновенно.',
  ...
  'ar' => [
    ...
    'description'      => 'اختبار معدل تحديث الشاشة: يكتشف تردد الشاشة الفعلي (60، 120، 144، 165، 240 هرتز) عبر قياس دقيق لزمن الإطار. بدون تثبيت، مباشرة في المتصفح.',
