...
<style>
:root{--bg-color:#f5f7fa;--text-color:#1e293b;--header-bg:linear-gradient(90deg,#4b5eAA,#7d8bc1);--header-text:#fff;--card-bg:#fff;--card-border:rgba(0,0,0,0.08);--accent-color:#4b5eAA}
html.dark-theme{--bg-color:#0f172a;--text-color:#e2e8f0;--header-bg:linear-gradient(90deg,#1e293b,#334155);--card-bg:#1e293b;--card-border:rgba(255,255,255,0.1)}
...
<!-- Deferred JS -->
<script defer src="<?php echo $basePath; ?>assets/js/theme.js"></script>
...
<!-- Mobile Theme Color -->
<meta name="theme-color" content="#4b5eAA" media="(prefers-color-scheme: light)">
