...
<script>
/* Wrap init in outer IIFE; defer past first LCP paint via rAF+setTimeout */
(function() {
    function _kbInit() {
(function() {
    'use strict';
    ...
    /* Run keyboard init after first LCP paint (rAF schedules before paint; setTimeout fires after) */
    requestAnimationFrame(function() { setTimeout(_kbInit, 0); });
})();
</script>
