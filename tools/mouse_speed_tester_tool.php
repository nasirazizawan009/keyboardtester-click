...
<div class="click-tester-section">
    <div class="click-tester">
        ...
        <div class="info-area">
            <div class="info-box">Duration <span id="sel-dur">5s</span></div>
            <div class="info-box">Clicks <span id="cur-clicks">—</span></div>
            <div class="info-box">Time Left <span id="time-left">5s</span></div>
        </div>
        ...
        <div class="result-strip" id="result-strip" style="display:none">
            ...
            <div class="result-row">
                <span class="result-label">Clicks</span>
                <span class="result-val" id="res-clicks">—</span>
            </div>
            <p class="result-remark" id="res-remark"></p>
            <button class="new-test-btn" id="new-test-btn">Start New Test</button>
        </div>
        ...
        <div class="test-history" id="test-history" style="display:none">
            ...
            <table class="history-table">
                <thead><tr><th>#</th><th>Duration</th><th>Clicks</th><th>CPS</th></tr></thead>
...
(function () {
    ...
    function getRemark(cps) {
        if (cps > 14) return "Butterfly god tier. Are you even human?";
        if (cps > 10) return "Jitter clicking! Your forearm disagrees.";
        if (cps > 7)  return "Above average — solid gaming pace!";
        if (cps > 4)  return "Average range. Room to improve!";
        return "Warm those fingers up!";
    }
