<div class="game-container">
    ...
    <div class="game-options">
        ...
        <div class="option-group">
            ...
            <button class="game-button" id="clearTrailBtn" onclick="clearTrail()">Clear Trail</button>
        </div>
    </div>
    ...
    <div id="help" class="game-help">
        <h3 class="game-help-title">Quick Help</h3>
        <p class="game-help-text">Move your mouse in the game area to create fun emoji trails. Choose different emojis from the dropdown to change the trail type. Your score increases based on the number of trails, their type, and movement patterns (tight circles or wild zigzags). Click "Clear Trail" to reset and start fresh!</p>
    </div>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function clearTrail() {
            ...
            if (gameArea && trails) {
                trails = [];
                gameArea.innerHTML = '';
                document.getElementById('result').innerHTML = 'Trail cleared! Start again.';
            } else {
