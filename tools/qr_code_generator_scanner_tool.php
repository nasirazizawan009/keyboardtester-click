  ...
  <div class="kbt-tool-grid two">
    <div class="kbt-tool-card">
      ...
      <div class="kbt-tool-field">
        ...
        <textarea class="kbt-tool-textarea" id="qr-text" rows="4" placeholder="Enter text or URL"></textarea>
      </div>
      <div class="kbt-tool-field">
      ...
      <div class="kbt-tool-actions">
        <button class="kbt-tool-button primary" id="qr-generate">Generate</button>
        <button class="kbt-tool-button ghost" id="qr-download">Download</button>
      </div>
    </div>
    <div class="kbt-tool-card">
      <h3>Preview</h3>
      <div class="qr-output" id="qr-output">QR code preview</div>
    </div>
  </div>
</div>
