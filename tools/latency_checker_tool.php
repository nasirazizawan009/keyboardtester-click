...
<div class="kbt-tool kbt-latency-tool" id="latency-tool">
  <div class="kbt-tool-grid two">
    <div class="kbt-tool-card">
      <h3>Latency test</h3>
      <p>Press any key while the test is active. We estimate the processing delay for each key press.</p>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  startBtn.addEventListener('click', function () {
    active = true;
    statusEl.textContent = 'Status: Testing (press keys)';
  ...
  clearBtn.addEventListener('click', function () {
    ...
    logEl.textContent = 'Press Start and then press keys to capture samples.';
  });
