<?php
// headphone_speaker_tester_tool.php – embeddable Headphone/Speaker Tester module (no <html> shell)
?>
<style>
  :root {
    --bg: #f6f8fc;
  ...
  <div class="hs-grid">
    ...
    <div>
      <div class="hs-card">
        <div id="hs-infoAlert" class="hs-alert hs-alert-info">
          🎧 <strong>Tip:</strong> Use headphones for the best stereo testing experience. Adjust your system volume to a comfortable level before starting.
        </div>
        ...
        <div class="hs-visualizer" id="hs-visualizer">
          <div class="hs-placeholder" id="hs-placeholder">
            ...
            <p style="margin: 8px 0 0; font-size: 13px;">Select a test below to begin</p>
          </div>
          ...
          <div class="hs-overlay" id="hs-overlay" style="display: none;">
            <div class="hs-badge">
              ...
              <span id="hs-statusText">Playing</span>
            </div>
        ...
        <div class="hs-controls">
          <button id="hs-stopBtn" class="hs-btn hs-btn-danger" disabled>Stop Audio</button>
        </div>
    ...
    <div>
      ...
      <div class="hs-card" style="margin-bottom: 16px;">
        <h3 style="margin: 0 0 16px; font-size: 16px;">Quick Channel Test</h3>
      ...
      <div class="hs-card">
        ...
        <div class="hs-test-grid">
          <div class="hs-test-item" data-test="sweep">
            <div class="hs-test-title">🎼 Frequency Sweep</div>
            <div class="hs-test-desc">20Hz to 20kHz sweep to test full audio range</div>
          </div>
          <div class="hs-test-item" data-test="bass">
            <div class="hs-test-title">🔉 Bass Test (100Hz)</div>
            <div class="hs-test-desc">Test low-frequency response and subwoofer</div>
          </div>
          <div class="hs-test-item" data-test="mid">
            <div class="hs-test-title">🔊 Mid Range (1kHz)</div>
            <div class="hs-test-desc">Test vocals and instrument clarity</div>
          </div>
          <div class="hs-test-item" data-test="treble">
            <div class="hs-test-title">🔔 Treble Test (10kHz)</div>
            <div class="hs-test-desc">Test high-frequency response and clarity</div>
          </div>
          <div class="hs-test-item" data-test="balance">
            <div class="hs-test-title">⚖️ Balance Test</div>
            <div class="hs-test-desc">Alternates between left and right channels</div>
          </div>
          <div class="hs-test-item" data-test="noise">
            <div class="hs-test-title">📻 White Noise</div>
            <div class="hs-test-desc">Full spectrum noise for speaker testing</div>
          </div>
        </div>
      </div>
      ...
      <div class="hs-card" style="margin-top: 16px;">
        <h3 style="margin: 0 0 16px; font-size: 16px;">Audio Information</h3>
        <div class="hs-info-grid">
          <div class="hs-info-item">
            <span class="hs-info-label">Status</span>
            <span class="hs-info-value" id="hs-infoStatus">Ready</span>
          </div>
          <div class="hs-info-item">
            <span class="hs-info-label">Current Test</span>
            <span class="hs-info-value" id="hs-infoTest">None</span>
          </div>
          <div class="hs-info-item">
            <span class="hs-info-label">Frequency</span>
            <span class="hs-info-value" id="hs-infoFrequency">-</span>
          </div>
          <div class="hs-info-item">
            <span class="hs-info-label">Channel</span>
...
(()=>{
  ...
  function playTone(frequency, panValue = 0, channelName = 'Stereo') {
    ...
    updateInfo(false, `${frequency}Hz Tone`, frequency, channelName);
  }
  ...
  function playNoise() {
    ...
    updateInfo(false, 'White Noise', 'Full Spectrum', 'Stereo');
  }
  ...
  function playSweep() {
    ...
    updateInfo(false, 'Frequency Sweep', '20Hz - 20kHz', 'Stereo');
  }
  ...
  function playBalance() {
    ...
    const balanceInterval = setInterval(() => {
      ...
      const channelName = panValue === -1 ? 'Left' : 'Right';
    ...
    updateInfo(false, 'Balance Test', '440Hz', 'Alternating');
  }
