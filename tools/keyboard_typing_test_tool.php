<?php
// Typing speed tool (centralized include)
?>
...
<div class="typing-test-container">
  ...
  <textarea id="typing-area" class="typing-area" placeholder="Start typing here..." disabled></textarea>
  <div class="timer-bar">
...
<div class="results-popup" id="results-popup">
  ...
  <p>Speed: <span id="final-speed">0</span> WPM</p>
  <p>Accuracy: <span id="final-accuracy">0</span>%</p>
  <p id="encouragement"></p>
  <button id="close-popup">Try Again</button>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const TEXTS = {
    easy: [
      ...
      'Practice makes progress. Keep your rhythm steady.',
      'Type with calm hands and focus on accuracy.'
    ],
    medium: [
      'Typing speed improves when you balance accuracy with steady rhythm.',
      'Warm up your fingers, keep your posture aligned, and stay relaxed.',
      'Short bursts of focused practice build lasting muscle memory.'
    ],
    hard: [
      'Precise typing is a blend of rhythm, attention, and refined muscle memory.',
      'Maintain a smooth cadence, correct errors quickly, and keep your eyes forward.',
      'Consistency over speed wins long tests; breathe, relax, and stay focused.'
    ]
  };
  ...
  function finishTest() {
    ...
    encouragement.textContent = Number(finalSpeed.textContent) >= 60
      ? 'Great pace! Keep training for consistency.'
      : 'Nice effort! Focus on accuracy and steady rhythm.';
