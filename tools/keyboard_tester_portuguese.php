...
<section class="keyboard-tester" id="keyboard-tester">
    <div class="keyboard-container">
        ...
        <div class="controls-wrapper">
            <div class="control-group">
                ...
                <button id="toggle-history-btn" class="btn btn-control">
                    <span class="btn-icon">📋</span>
                    <span class="btn-label">Histórico de Teclas</span>
                </button>
            </div>
            <div class="control-group">
                <label for="theme-selector" class="control-label">Tema:</label>
            ...
            <div class="control-group">
                <label for="layout-selector" class="control-label">Distribuição:</label>
                <select id="layout-selector" class="layout-selector">
                    <option value="qwerty">QWERTY Português</option>
        ...
        <div class="statistics-wrapper">
            <div class="stat-item">
                <span class="stat-label">Total de Pressionamentos:</span>
        ...
        <div class="keyboard" id="keyboard">
            ...
            <div class="key-row">
                ...
                <div class="key" data-key="ç" data-shift="Ç">ç</div>
                <div class="key" data-key="~" data-shift="^">~</div>
        ...
        <div class="ghost-detection" id="ghost-detection" style="display: none;">
            <div class="detection-header">⚠️ Problemas com o Teclado Detectados</div>
