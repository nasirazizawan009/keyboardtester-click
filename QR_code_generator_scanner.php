        ...
        <div class="process-grid">
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/qr-generator/step-1.svg'); ?>" alt="Start the test" loading="lazy">
            </div>
          ...
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/qr-generator/step-2.svg'); ?>" alt="Enter your data" loading="lazy">
            </div>
          ...
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/qr-generator/step-3.svg'); ?>" alt="Review results" loading="lazy">
            </div>
