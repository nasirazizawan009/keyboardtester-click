    ...
    <div class="footer-container">
        ...
        <div class="footer-section about-section">
            ...
            <div class="social-links">
                <a href="<?php echo $socialLinks['github']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Download source code on GitHub">
                ...
                <a href="<?php echo $socialLinks['gitlab']; ?>" target="_blank" rel="noopener noreferrer" aria-label="View source code on GitLab">
                    <svg width="18" height="18" viewBox="0 0 24 24">
                        <path d="M23.955 13.587l-1.342-4.135-2.664-8.189a.455.455 0 0 0-.867 0L16.418 9.45H7.582L4.918 1.263a.455.455 0 0 0-.867 0L1.387 9.452.045 13.587a.924.924 0 0 0 .331 1.023L12 22.816l11.624-8.206a.924.924 0 0 0 .331-1.023" fill="#e24329"/>
                        <path d="M12 22.816L16.418 9.45H7.582z" fill="#fc6d26"/>
                        <path d="M12 22.816l-4.418-13.366H1.387z" fill="#fca326"/>
                        <path d="M1.387 9.45L.045 13.587a.924.924 0 0 0 .331 1.023L12 22.816z" fill="#e24329"/>
                        <path d="M1.387 9.45h6.195L4.918 1.263a.455.455 0 0 0-.867 0z" fill="#fc6d26"/>
                        <path d="M12 22.816l4.418-13.366h6.195z" fill="#fca326"/>
                        <path d="M22.613 9.45l1.342 4.137a.924.924 0 0 1-.331 1.023L12 22.816z" fill="#e24329"/>
                        <path d="M22.613 9.45h-6.195l2.664-8.187a.455.455 0 0 1 .867 0z" fill="#fc6d26"/>
                    </svg>
                    GitLab
                </a>
                <a href="<?php echo $socialLinks['youtube']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Watch tutorials on YouTube">
                    <svg width="18" height="18" viewBox="0 0 24 24">
                ...
                <a href="<?php echo $socialLinks['facebook']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook">
                    <svg width="18" height="18" viewBox="0 0 24 24">
