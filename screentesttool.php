    ...
    <div>
      <div class="st-card">
        ...
        <div class="st-colors-grid">
          <button class="st-color-btn" style="background: #000;" onclick="setPreviewColor('#000000', 'Black')" title="Black - Best for finding dead pixels">
            Black
          </button>
          <button class="st-color-btn" style="background: #fff; color: #000; text-shadow: none;" onclick="setPreviewColor('#FFFFFF', 'White')" title="White - Best for finding stuck pixels">
            White
          </button>
          <button class="st-color-btn" style="background: #ff0000;" onclick="setPreviewColor('#FF0000', 'Red')" title="Red - Check red sub-pixels">
            Red
          </button>
          <button class="st-color-btn" style="background: #00ff00;" onclick="setPreviewColor('#00FF00', 'Green')" title="Green - Check green sub-pixels">
            Green
          </button>
          <button class="st-color-btn" style="background: #0000ff;" onclick="setPreviewColor('#0000FF', 'Blue')" title="Blue - Check blue sub-pixels">
            Blue
          </button>
          <button class="st-color-btn" style="background: #ffff00; color: #000; text-shadow: none;" onclick="setPreviewColor('#FFFF00', 'Yellow')" title="Yellow - R+G sub-pixels">
            Yellow
          </button>
          <button class="st-color-btn" style="background: #ff00ff;" onclick="setPreviewColor('#FF00FF', 'Magenta')" title="Magenta - R+B sub-pixels">
            Magenta
          </button>
          <button class="st-color-btn" style="background: #00ffff; color: #000; text-shadow: none;" onclick="setPreviewColor('#00FFFF', 'Cyan')" title="Cyan - G+B sub-pixels">
            Cyan
          </button>
        </div>

        <div class="st-alert st-alert-info">
          <strong>💡 Pro Tip:</strong> Clean your screen first! Use arrow keys (← →) or click to cycle through colors in full-screen mode. Press ESC to exit.
        </div>
      </div>
    </div>
    ...
    <div>
      <div class="st-card">
        ...
        <div class="st-stats-grid">
          ...
          <div class="st-stat-card">
            <div class="label">Colors Tested</div>
        ...
        <div class="st-section">
          ...
          <ul class="st-tips-list">
            <li><strong>Dead Pixels:</strong> Permanent black dots (all colors)</li>
            <li><strong>Stuck Pixels:</strong> Dots stuck on one color (red/green/blue)</li>
            <li><strong>Hot Pixels:</strong> Always white pixels</li>
            <li><strong>Color Uniformity:</strong> Even color across entire screen</li>
          </ul>
        </div>
        ...
        <div class="st-section">
          ...
          <ul class="st-tips-list">
            ...
            <li>Test in a dark or dimly lit room</li>
            <li>View from your normal distance</li>
            <li>Test all 8 colors thoroughly</li>
            <li>Look at edges and corners carefully</li>
            <li>Take your time - don't rush</li>
          </ul>
        </div>

        <div class="st-alert st-alert-success">
          <strong>🔒 Privacy First:</strong> This test runs entirely in your browser. No data is collected or sent to any server.
        </div>
      </div>
    </div>
  </div>
...
<div class="st-fullscreen-test" id="st-fullscreen-test">
  <div class="st-fs-instructions" id="st-fs-instructions">
    <div style="font-weight: 600; margin-bottom: 8px;">Screen Test Active</div>
    <div style="font-size: 12px;">Use arrow keys (← →) or click to cycle colors • Press ESC to exit</div>
  </div>
  <div class="st-fs-controls">
    <button class="st-fs-btn" onclick="previousColor()">← Previous</button>
    <button class="st-fs-btn" onclick="nextColor()">Next →</button>
    <button class="st-fs-btn" onclick="exitFullScreen()">Exit (ESC)</button>
  </div>
</div>

<script>
  const colors = [
    { hex: '#000000', name: 'Black', desc: 'Look for dead pixels (black dots)' },
    { hex: '#FFFFFF', name: 'White', desc: 'Look for stuck pixels (colored dots)' },
    { hex: '#FF0000', name: 'Red', desc: 'Check red sub-pixels' },
    { hex: '#00FF00', name: 'Green', desc: 'Check green sub-pixels' },
    { hex: '#0000FF', name: 'Blue', desc: 'Check blue sub-pixels' },
    { hex: '#FFFF00', name: 'Yellow', desc: 'Red + Green sub-pixels' },
    { hex: '#FF00FF', name: 'Magenta', desc: 'Red + Blue sub-pixels' },
