...
/**
 * Normalize internal site paths before rendering them into links.
 * Preserves query strings and fragments while upgrading legacy aliases.
 *
 * @param string $path
 * @return string
 */
function normalizeSitePath($path = '') {
    ...
    $normalizedPath = canonicalizeRequestPath($parts['path'] ?? '');
    $suffix = '';
...
function canonicalizeRequestPath($requestUri = '') {
    ...
    $legacyMap = [
        ...
        'click-speed-test.php' => 'mouse_speed_tester.php',
        'contact.php' => 'feedback.php',
        'dpi-tester.php' => 'mouse_sensitivity_DPI_tester.php',
        'ghost-click-test.php' => 'ghost-click-detector.php',
        ...
        'password-generator.php' => 'auto-password-generator.php',
        'privacy.php' => 'privacy-policy.php',
        'qr-generator.php' => 'QR_code_generator_scanner.php',
        'qr-reader.php' => 'qr-code-reader.php',
...
$keyboardLanguages = [
    'en' => ['url' => url(''), 'name' => 'English', 'native' => 'English', 'flag' => 'flags/us_flag.svg'],
    ...
    'ja' => ['url' => url('languages/japanese/'), 'name' => 'Japanese', 'native' => '日本語', 'flag' => 'flags/japanese_flag.svg'],
