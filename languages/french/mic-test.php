...
<head>
  ...
  <link rel="alternate" hreflang="fr" href="<?php echo absoluteUrl('languages/french/mic-test.php'); ?>">
...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    ...
    <?php $localizedClusterLanguage = 'french'; $localizedClusterKey = 'mic'; $localizedClusterCurrent = 'mic-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
    <?php $localizedClusterLanguage = 'french'; $localizedClusterKey = 'mic'; $localizedClusterCurrent = 'mic-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
