<?php
// Outil de test de DPI / Sensibilite de la souris (independant)
?>

<div class="kbt-tool kbt-dpi-tool" id="dpi-tool">
  <div class="kbt-tool-grid two">
    <div class="kbt-tool-card">
      <h3>Estimation du DPI</h3>
      <p>Entrez la distance physique que vous deplacez votre souris, puis faites glisser dans la zone de suivi.</p>
      <div class="kbt-tool-field">
        <label for="dpi-distance">Distance parcourue</label>
      ...
      <div class="kbt-tool-actions">
        <button class="kbt-tool-button primary" id="dpi-start">Demarrer la mesure</button>
        <button class="kbt-tool-button" id="dpi-reset">Reinitialiser</button>
      </div>
    </div>
    <div class="kbt-tool-card">
      <h3>Zone de suivi</h3>
      <div class="dpi-track" id="dpi-track" aria-label="Zone de suivi du DPI">
        Faites glisser ici en maintenant le bouton de la souris enfonce.
      </div>
      <div class="kbt-tool-stats">
        <div class="kbt-tool-stat"><span>Pixels parcourus</span><strong id="dpi-pixels">0 px</strong></div>
        <div class="kbt-tool-stat"><span>DPI estime</span><strong id="dpi-result">--</strong></div>
      </div>
    </div>
  </div>
</div>
