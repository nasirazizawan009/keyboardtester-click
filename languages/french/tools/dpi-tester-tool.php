<?php
// Outil de test DPI v2.0 — Français
$dpi_strings = [
  'tab_test'   => 'Test DPI',
  'tab_edpi'   => 'Calculateur eDPI',
  'tab_conv'   => 'Convertisseur',
  'setup'      => '1 — Configuration',
  'lbl_dist'   => 'Distance physique que vous déplacerez la souris',
  'unit_cm'    => 'cm',
  'unit_in'    => 'pouces',
  'lbl_exp'    => 'DPI attendu',
  'exp_hint'   => '(facultatif — active déviation et précision)',
  'lbl_axis'   => 'Restreindre l\'axe de mesure',
  'axis_both'  => 'N\'importe quelle direction (recommandé)',
  'axis_x'     => 'Horizontal uniquement (axe X)',
  'axis_y'     => 'Vertical uniquement (axe Y)',
  'btn_start'  => '▶ Démarrer la mesure',
  'btn_reset'  => 'Tout réinitialiser',
  'tip'        => '<strong>Conseil :</strong> Utilisez une règle sur votre tapis de souris. Marquez un début et une fin, puis faites glisser dans la zone de suivi en maintenant le bouton de la souris.',
  'track_lbl'  => 'Zone de suivi DPI',
  'track_title'=> '2 — Suivi et résultats',
  'track_idle' => 'Cliquez sur Démarrer, puis faites glisser ici',
  'track_ready'=> 'Maintenez le bouton + faites glisser sur la distance mesurée',
  'stat_px'    => 'Pixels parcourus',
  'stat_dpi'   => 'DPI estimé',
  'stat_dev'   => 'Déviation',
  'stat_acc'   => 'Précision',
  'runs_lbl'   => 'Historique des essais (faites glisser pour en ajouter)',
  'run_n'      => 'Essai',
  'run_avg'    => 'Moy :',
  'run_more'   => ' sur %d — faites glisser à nouveau ↔',
  'run_done'   => 'Tous les essais terminés — voir la moyenne ci-dessus',
  'privacy'    => '🔒 Ce test s\'exécute entièrement dans votre navigateur. Aucune donnée n\'est collectée.',
  'edpi_setup' => 'Votre configuration',
  'lbl_dpi'    => 'DPI de la souris',
  'lbl_sens'   => 'Sensibilité en jeu',
  'lbl_game'   => 'Jeu (pour comparaison)',
  'game_any'   => '— Quelconque / Personnalisé —',
  'edpi_lbl'   => 'eDPI — DPI effectif',
  'edpi_formula'=> '<strong>Formule :</strong> eDPI = DPI souris × Sensibilité en jeu',
  'pro_title'  => 'Comparaison des plages pro',
  'pro_intro'  => 'Votre eDPI est mis en évidence dans le tableau.',
  'pro_h1'     => 'Plage eDPI', 'pro_h2' => 'Niveau', 'pro_h3' => 'Courant chez',
  'conv_curr'  => 'Configuration actuelle',
  'lbl_old_dpi'=> 'DPI actuel',
  'lbl_old_s'  => 'Sensibilité actuelle en jeu',
  'conv_target'=> 'Configuration cible',
  'lbl_new_dpi'=> 'Nouveau DPI (après changement de souris)',
  'conv_sub'   => 'Nouvelle sensibilité — même mémoire musculaire, DPI différent',
  'conv_how'   => 'Comment ça fonctionne',
  'conv_exp1'  => 'Le convertisseur maintient votre <strong>eDPI constant</strong>, de sorte que le même mouvement physique déplace toujours votre vue en jeu de la même distance.',
  'conv_formula'=> 'nouvelle_sens = (ancien_DPI × ancienne_sens) / nouveau_DPI',
  'conv_exp2'  => '<strong>Exemple :</strong> 400 DPI à 2.0 sens → 800 DPI à 1.0 sens. Les deux ont eDPI 800.',
  'log_title'  => 'Journal de session',
  'log_dl'     => '&#11015; Télécharger le journal (.txt)',
  'log_empty'  => 'Aucun essai enregistré. Effectuez un test DPI pour commencer.',
];
?>
...
<div class="kbt-tool dpi-v2" id="dpi-tool">
  ...
  <div class="dpi-panel active" id="dpi-p-test" role="tabpanel">
    <div class="dpi-mode-row"><div class="dpi-mode-toggle"><button class="dpi-mode-btn active" data-mode="basic">Basique</button><button class="dpi-mode-btn" data-mode="advanced">Avancé</button></div></div>
    <div class="dpi-grid">
      <div class="dpi-card">
  ...
  <div class="dpi-panel" id="dpi-p-edpi" role="tabpanel">
    <div class="dpi-grid">
      ...
      <div class="dpi-card">
        ...
        <tbody id="edpi-tbody">
          <tr data-min="0"    data-max="400">   <td>200–400</td>  <td>Ultra bas</td>   <td>Pro FPS (S1mple, sh1ro)</td></tr>
          <tr data-min="400"  data-max="800">   <td>400–800</td>  <td>Bas</td>         <td>FPS compétitif / pros Valorant</td></tr>
          <tr data-min="800"  data-max="1600">  <td>800–1600</td> <td>Moyen</td>       <td>Gaming général, FPS casual</td></tr>
          <tr data-min="1600" data-max="3200">  <td>1600–3200</td><td>Élevé</td>       <td>MOBA / RTS</td></tr>
          <tr data-min="3200" data-max="999999"><td>3200+</td>    <td>Très élevé</td>  <td>Bureau, design, casual</td></tr>
        </tbody></table>
      </div>
    </div>
    <p class="dpi-privacy"><?php echo $dpi_strings['privacy']; ?></p>
  ...
  <div class="dpi-panel" id="dpi-p-conv" role="tabpanel">
    <div class="dpi-grid">
      <div class="dpi-card">
        ...
        <div class="dpi-conv-result"><p class="dpi-conv-formula" id="conv-formula">nouv_sens = (400 &times; 2.0) / 800</p><div class="dpi-conv-val" id="conv-val">1.0000</div><p class="dpi-conv-sub"><?php echo $dpi_strings['conv_sub']; ?></p></div>
      </div>
      <div class="dpi-card">
...
function updConv(){var od=parseFloat(cOd.value)||0,os=parseFloat(cOs.value)||0,nd=parseFloat(cNd.value)||0;if(od&&os&&nd){cFm.innerHTML='nouv_sens = ('+od+' &times; '+os+') / '+nd;cVl.textContent=((od*os)/nd).toFixed(4);}else{cVl.textContent='--';}}
