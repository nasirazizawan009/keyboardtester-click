...
<header class="site-header" id="siteHeader">
    <div class="header-container">
        ...
        <button class="menu-toggle" id="menuToggle" aria-label="Basculer le menu">
            <span></span><span></span><span></span>
        </button>
        <nav class="site-nav" id="siteNav">
            <a class="nav-link" href="<?php echo $pages['home']; ?>">Accueil</a>
            <button class="nav-link" id="toolsToggle">Outils</button>
            <a class="nav-link" href="<?php echo $pages['privacy']; ?>">Confidentialite</a>
            <a class="nav-link" href="<?php echo $pages['about']; ?>">A propos</a>
            <div class="nav-actions">
                <div class="lang-selector" id="langSelector">
                    <button class="lang-toggle" id="langToggle">🌐 <span>FR</span></button>
                    <div class="lang-dropdown" id="langDropdown">
                        ...
                        <a href="<?php echo url('languages/french/'); ?>" class="lang-option active"><span class="lang-flag">🇫🇷</span>Francais</a>
                ...
                <a href="<?php echo $pages['home']; ?>#tools" class="cta-btn">Tester les Outils</a>
            </div>
        </nav>
    </div>
    <div class="mega-panel" id="toolsPanel">
        <div class="panel-inner">
            <div>
                <div class="panel-title"><span class="panel-title-icon">⌨️</span> Clavier</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['home']; ?>">Testeur de Clavier</a>
                    <a href="<?php echo $pages['keyboard_typing']; ?>">Test de Vitesse</a>
                    <a href="<?php echo $pages['latency_check']; ?>">Verificateur de Latence</a>
                    <a href="<?php echo url('languages/french/spacebar-test.php'); ?>">Test Barre Espace</a>
                    <a href="<?php echo url('languages/french/reaction-time-test.php'); ?>">Temps de Réaction</a>
                    <a href="<?php echo url('keyboard-ghosting-test.php'); ?>">Test Ghosting</a>
                    <a href="<?php echo url('n-key-rollover-test.php'); ?>">N-Key Rollover</a>
                    <a href="<?php echo url('stuck-key-test.php'); ?>">Touche Bloquée</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🖱️</span> Souris</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['mouse_test']; ?>">Testeur de Souris</a>
                    <a href="<?php echo $pages['click_speed']; ?>">Test de Vitesse de Clic</a>
                    <a href="<?php echo $pages['ghost_click']; ?>">Detecteur de Clics Fantomes</a>
                    <a href="<?php echo $pages['dpi_tester']; ?>">Test de DPI</a>
                    <a href="<?php echo url('languages/french/mouse-trail.php'); ?>">Traînée Souris</a>
                    <a href="<?php echo url('languages/french/polling-rate-test.php'); ?>">Taux d'Interrogation</a>
                    <a href="<?php echo url('scroll-wheel-test.php'); ?>">Test Molette</a>
                    <a href="<?php echo url('double-click-test.php'); ?>">Double Clic</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🖥️</span> Ecran</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['screen_test']; ?>">Test d'Ecran</a>
                    <a href="<?php echo $pages['webcam_test']; ?>">Test de Webcam</a>
                    <a href="<?php echo url('languages/french/dead-pixel-test.php'); ?>">Pixel Mort</a>
                    <a href="<?php echo url('stuck-pixel-test.php'); ?>">Pixel Bloqué</a>
                    <a href="<?php echo url('black-screen-test.php'); ?>">Écran Noir</a>
                    <a href="<?php echo url('white-screen-test.php'); ?>">Écran Blanc</a>
                    <a href="<?php echo url('languages/french/refresh-rate-test.php'); ?>">Fréquence Rafraîch.</a>
                    <a href="<?php echo url('languages/french/color-test.php'); ?>">Test de Couleur</a>
                    <a href="<?php echo url('languages/french/touch-screen-test.php'); ?>">Écran Tactile</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🎧</span> Audio</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['mic_test']; ?>">Test de Microphone</a>
                    <a href="<?php echo $pages['headphone_test']; ?>">Test de Casque</a>
                    <a href="<?php echo url('microphone-volume-test.php'); ?>">Volume Micro</a>
                    <a href="<?php echo url('left-right-speaker-test.php'); ?>">Haut-parleur G/D</a>
                    <a href="<?php echo url('stereo-test.php'); ?>">Test Stéréo</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🛠️</span> Utilitaires</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['qr_generator']; ?>">Generateur QR</a>
                    <a href="<?php echo $pages['qr_reader']; ?>">Lecteur QR</a>
                    <a href="<?php echo $pages['ocr_tool']; ?>">Outil OCR</a>
                    <a href="<?php echo $pages['password_gen']; ?>">Generateur de Mots de Passe</a>
                    <a href="<?php echo url('languages/french/gamepad-test.php'); ?>">Test Manette</a>
                </div>
            </div>
        </div>
    </div>
