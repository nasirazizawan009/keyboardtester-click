...
<footer class="site-footer">
    <div class="footer-container">
        <div class="footer-section about-section">
            ...
            <p class="footer-description">Outils de test modernes pour claviers, souris, audio, ecrans et plus encore, concus pour la clarte, la precision et la rapidite.</p>
            <div class="social-links">
                <a href="<?php echo $socialLinks['github']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Télécharger sur GitHub">
                ...
                <a href="<?php echo $socialLinks['gitlab']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Voir sur GitLab">
                ...
                <a href="<?php echo $socialLinks['youtube']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Voir sur YouTube">
                ...
                <a href="<?php echo $socialLinks['facebook']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Suivre sur Facebook">
        ...
        <div class="footer-section">
            ...
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">Accueil</a></li>
                <li><a href="<?php echo $pages['blog']; ?>">Blog</a></li>
                <li><a href="<?php echo $pages['about']; ?>">A propos</a></li>
                <li><a href="<?php echo $pages['privacy']; ?>">Confidentialite</a></li>
                <li><a href="<?php echo $pages['disclaimer']; ?>">Avertissement</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">Outils de Test</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">Testeur de Clavier</a></li>
                <li><a href="<?php echo $pages['mouse_test']; ?>">Testeur de Souris</a></li>
                <li><a href="<?php echo $pages['keyboard_typing']; ?>">Test de Vitesse</a></li>
                <li><a href="<?php echo $pages['screen_test']; ?>">Testeur d'Ecran</a></li>
                <li><a href="<?php echo $pages['mic_test']; ?>">Testeur de Microphone</a></li>
                <li><a href="<?php echo $pages['webcam_test']; ?>">Testeur de Webcam</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">Plus d'Outils</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['qr_generator']; ?>">Generateur QR</a></li>
                <li><a href="<?php echo $pages['ocr_tool']; ?>">Outil OCR</a></li>
                <li><a href="<?php echo $pages['password_gen']; ?>">Generateur de Mots de Passe</a></li>
                <li><a href="<?php echo $pages['ghost_click']; ?>">Detecteur de Clics Fantomes</a></li>
                <li><a href="<?php echo url('languages/french/polling-rate-test.php'); ?>">🖱️ Test de Taux d'Interrogation</a></li>
                <li><a href="<?php echo url('languages/french/refresh-rate-test.php'); ?>">🖥️ Test de Fréquence de Rafraîchissement</a></li>
                <li><a href="<?php echo url('languages/french/color-test.php'); ?>">🎨 Test de Couleur du Moniteur</a></li>
                <li><a href="<?php echo url('languages/french/touch-screen-test.php'); ?>">🖥️ Test d'Écran Tactile</a></li>
                <li><a href="<?php echo url('languages/french/gamepad-test.php'); ?>">🎮 Test de Manette de Jeu</a></li>
            </ul>
        </div>
        <div class="footer-section contact-section">
            ...
            <div class="newsletter">
                <p>Recevez des mises a jour sur les nouveaux outils</p>
    ...
    <div class="footer-bottom">
        <p class="copyright">&copy; <?php echo $siteYear; ?> <a href="<?php echo $pages['home']; ?>"><?php echo $siteName; ?></a>. Tous droits reserves.</p>
        <p class="tagline">Fait avec <span class="heart">❤️</span> pour les passionnes de technologie du monde entier</p>
    </div>
</footer>
