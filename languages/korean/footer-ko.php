...
<footer class="site-footer">
    <div class="footer-container">
        <div class="footer-section about-section">
            ...
            <p class="footer-description">키보드, 마우스, 오디오, 화면 등을 위한 현대적인 테스트 도구. 명확성, 정확성, 속도를 위해 설계되었습니다.</p>
            <div class="social-links">
                <a href="<?php echo $socialLinks['github']; ?>" target="_blank" rel="noopener noreferrer" aria-label="GitHub에서 다운로드">
                ...
                <a href="<?php echo $socialLinks['gitlab']; ?>" target="_blank" rel="noopener noreferrer" aria-label="GitLab에서 보기">
                ...
                <a href="<?php echo $socialLinks['youtube']; ?>" target="_blank" rel="noopener noreferrer" aria-label="YouTube에서 보기">
                ...
                <a href="<?php echo $socialLinks['facebook']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Facebook 팔로우">
        ...
        <div class="footer-section">
            <h4 class="footer-heading">빠른 링크</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">홈</a></li>
                <li><a href="<?php echo $pages['blog']; ?>">블로그</a></li>
                <li><a href="<?php echo $pages['about']; ?>">소개</a></li>
                <li><a href="<?php echo $pages['privacy']; ?>">개인정보</a></li>
                <li><a href="<?php echo $pages['disclaimer']; ?>">면책조항</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">테스트 도구</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">키보드 테스터</a></li>
                <li><a href="<?php echo $pages['mouse_test']; ?>">마우스 테스터</a></li>
                <li><a href="<?php echo $pages['keyboard_typing']; ?>">타이핑 속도 테스트</a></li>
                <li><a href="<?php echo $pages['screen_test']; ?>">화면 테스터</a></li>
                <li><a href="<?php echo $pages['mic_test']; ?>">마이크 테스터</a></li>
                <li><a href="<?php echo $pages['webcam_test']; ?>">웹캠 테스터</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">더 많은 도구</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['qr_generator']; ?>">QR 생성기</a></li>
                <li><a href="<?php echo $pages['ocr_tool']; ?>">OCR 도구</a></li>
                <li><a href="<?php echo $pages['password_gen']; ?>">비밀번호 생성기</a></li>
                <li><a href="<?php echo $pages['ghost_click']; ?>">고스트 클릭 감지기</a></li>
                <li><a href="<?php echo url('languages/korean/polling-rate-test.php'); ?>">🖱️ 폴링 레이트 테스트</a></li>
                <li><a href="<?php echo url('languages/korean/refresh-rate-test.php'); ?>">🖥️ 주사율 테스트</a></li>
                <li><a href="<?php echo url('languages/korean/color-test.php'); ?>">🎨 모니터 색상 테스트</a></li>
                <li><a href="<?php echo url('languages/korean/touch-screen-test.php'); ?>">👆 터치스크린 테스트</a></li>
                <li><a href="<?php echo url('languages/korean/gamepad-test.php'); ?>">🎮 게임패드 테스트</a></li>
            </ul>
        </div>
