...
<head>
  ...
  <link rel="alternate" hreflang="ko" href="<?php echo absoluteUrl('languages/korean/screen-test.php'); ?>">
...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    ...
    <!-- Tools List -->
    <?php $localizedClusterLanguage = 'korean'; $localizedClusterKey = 'screen'; $localizedClusterCurrent = 'screen-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
    <?php $localizedClusterLanguage = 'korean'; $localizedClusterKey = 'screen'; $localizedClusterCurrent = 'screen-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
