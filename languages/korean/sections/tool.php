<?php
/**
 * Korean Keyboard Tester - Full Layout Tool (두벌식 Dubeolsik Layout)
 */
$catProgressCssPath = __DIR__ . '/../../../assets/css/keyboard-cat-progress.css';
$catProgressJsPath = __DIR__ . '/../../../assets/js/keyboard-cat-progress.min.js';
...
<section class="keyboard-tester" id="keyboard-tester">
    <div class="controls-wrapper">
        <div class="textarea-wrapper">
            <div class="textarea-label">키 기록</div>
            <textarea class="text-box" id="key-history" rows="4" placeholder="아무 키나 눌러 테스트를 시작하세요..."></textarea>
        </div>
    ...
    <div class="feature-controls" id="feature-controls" style="display: none;">
        ...
        <button class="feature-button" id="sound-button">
            ...
            <span class="sound-label">소리: 꺼짐</span>
        </button>
    ...
    <div class="stats-panel" id="stats-panel" style="display: none;">
        <div class="stats-header">
            <h3><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 20V10M12 20V4M6 20v-6"/></svg> 세션 통계</h3>
            <button class="close-btn" id="close-stats">&times;</button>
        </div>
        <div class="stats-content">
            <div class="stat-item"><span class="stat-label">총 키 입력</span><span class="stat-value" id="total-keys">0</span></div>
            <div class="stat-item"><span class="stat-label">세션 시간</span><span class="stat-value" id="session-time">00:00</span></div>
            <div class="stat-item"><span class="stat-label">테스트된 키</span><span class="stat-value" id="keys-tested">0/104</span></div>
            <div class="stat-item"><span class="stat-label">가장 많이 누른 키</span><span class="stat-value" id="most-pressed">없음</span></div>
        </div>
    </div>

    <div class="stats-panel" id="latency-panel" style="display: none;">
        <div class="stats-header">
            <h3><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg> 지연 시간 테스트</h3>
        ...
        <div class="stats-content">
            <div class="stat-item latency-display">
                ...
                <div class="latency-sublabel">현재 지연 시간</div>
            </div>
            <div class="latency-grid">
                <div class="stat-item compact"><span class="stat-value mono" id="avg-latency">--</span><span class="stat-label">평균</span></div>
                <div class="stat-item compact"><span class="stat-value mono" id="min-latency">--</span><span class="stat-label">최소</span></div>
                <div class="stat-item compact"><span class="stat-value mono" id="max-latency">--</span><span class="stat-label">최대</span></div>
            </div>
        </div>
    </div>
        ...
        <div class="keyboard-layout">
            <div class="keyboard-section main-keyboard">
                ...
                <div class="key-row">
                    ...
                    <button class="key key-2x" data-key="Backspace"><span>백스페이스</span></button>
                </div>
                ...
                <!-- Korean Dubeolsik Layout Row 2: ㅁㄴㅇㄹㅎㅗㅓㅏㅣ -->
                <div class="key-row">
                    <button class="key key-1-75x" data-key="CapsLock"><span>Caps Lock</span></button>
                    <button class="key korean-key" data-key="KeyA"><span class="hangul-dual"><span class="hangul">ㅁ</span><span class="latin">A</span></span></button>
                    <button class="key korean-key" data-key="KeyS"><span class="hangul-dual"><span class="hangul">ㄴ</span><span class="latin">S</span></span></button>
                    <button class="key korean-key" data-key="KeyD"><span class="hangul-dual"><span class="hangul">ㅇ</span><span class="latin">D</span></span></button>
                    <button class="key korean-key" data-key="KeyF"><span class="hangul-dual"><span class="hangul">ㄹ</span><span class="latin">F</span></span></button>
                    <button class="key korean-key" data-key="KeyG"><span class="hangul-dual"><span class="hangul">ㅎ</span><span class="latin">G</span></span></button>
                    <button class="key korean-key" data-key="KeyH"><span class="hangul-dual"><span class="hangul">ㅗ</span><span class="latin">H</span></span></button>
                    <button class="key korean-key" data-key="KeyJ"><span class="hangul-dual"><span class="hangul">ㅓ</span><span class="latin">J</span></span></button>
                    <button class="key korean-key" data-key="KeyK"><span class="hangul-dual"><span class="hangul">ㅏ</span><span class="latin">K</span></span></button>
                    <button class="key korean-key" data-key="KeyL"><span class="hangul-dual"><span class="hangul">ㅣ</span><span class="latin">L</span></span></button>
                    <button class="key" data-key="Semicolon"><span class="dual">:<br>;</span></button>
                ...
                <!-- Korean Dubeolsik Layout Row 3: ㅋㅌㅊㅍㅠㅜㅡ -->
                <div class="key-row">
                    <button class="key key-2-25x" data-key="ShiftLeft"><span>Shift</span></button>
                    <button class="key korean-key" data-key="KeyZ"><span class="hangul-dual"><span class="hangul">ㅋ</span><span class="latin">Z</span></span></button>
                    <button class="key korean-key" data-key="KeyX"><span class="hangul-dual"><span class="hangul">ㅌ</span><span class="latin">X</span></span></button>
                    <button class="key korean-key" data-key="KeyC"><span class="hangul-dual"><span class="hangul">ㅊ</span><span class="latin">C</span></span></button>
                    <button class="key korean-key" data-key="KeyV"><span class="hangul-dual"><span class="hangul">ㅍ</span><span class="latin">V</span></span></button>
                    <button class="key korean-key" data-key="KeyB"><span class="hangul-dual"><span class="hangul">ㅠ</span><span class="latin">B</span></span></button>
                    <button class="key korean-key" data-key="KeyN"><span class="hangul-dual"><span class="hangul">ㅜ</span><span class="latin">N</span></span></button>
                    <button class="key korean-key" data-key="KeyM"><span class="hangul-dual"><span class="hangul">ㅡ</span><span class="latin">M</span></span></button>
                ...
                <div class="key-row">
                    ...
                    <button class="key key-space" data-key="Space"><span>스페이스</span></button>
                    ...
                    <button class="key key-1-25x" data-key="ContextMenu"><span>메뉴</span></button>
            ...
            <div class="keyboard-section numpad-section">
                <div class="indicator-panel">
                    ...
                    <div class="indicator" id="scroll-indicator"><div class="led" id="scroll-led"></div><span>Scrl</span></div>
                </div>
...
<style>
@import url('https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700&family=Noto+Sans+KR:wght@400;500;600;700&display=swap');
...
.keyboard-tester {
    ...
    width: 100%; padding: 40px 24px; background: var(--bg-primary); font-family: 'Noto Sans KR', 'Plus Jakarta Sans', sans-serif; position: relative; overflow: hidden;
}
...
.key.active-1 .hangul-dual .latin { color: rgba(0, 0, 0, 0.6) !important; }
...
.key.active-2 .hangul-dual .hangul { color: #000 !important; }
.key.active-2 .hangul-dual .latin { color: rgba(0, 0, 0, 0.6) !important; }
...
.key.active-3 .hangul-dual .hangul { color: #000 !important; }
.key.active-3 .hangul-dual .latin { color: rgba(0, 0, 0, 0.6) !important; }
...
.key.active-4 .hangul-dual .hangul { color: #fff !important; }
.key.active-4 .hangul-dual .latin { color: rgba(255, 255, 255, 0.7) !important; }
...
.key.active-5 .hangul-dual .hangul { color: #fff !important; }
.key.active-5 .hangul-dual .latin { color: rgba(255, 255, 255, 0.7) !important; }
...
(function() {
    ...
    const catProgress = (catProgressRoot && window.KeyboardCatProgress)
        ? new window.KeyboardCatProgress(catProgressRoot, { desktopTotalKeys: TOTAL_KEYS, mobileTotalKeys: 42, locale: 'ko' })
        : null;

    // Korean Dubeolsik character mapping
    const koreanKeyMap = {
    ...
    if (soundButton) soundButton.addEventListener('click', () => { state.soundEnabled = !state.soundEnabled; soundButton.classList.toggle('active', state.soundEnabled); soundButton.querySelector('.sound-label').textContent = state.soundEnabled ? '소리: 켜짐' : '소리: 꺼짐'; });
...
function handleKeyDown(e) {
        ...
        let keyName = koreanKeyMap[e.code] || (e.key.length === 1 ? e.key : e.code);
    ...
    function reset() { state.keyPressCount = {}; state.uniqueKeys.clear(); state.totalPresses = 0; state.sessionStart = null; state.latencyData = []; state.lastKeyTime = 0; if (state.sessionTimer) { clearInterval(state.sessionTimer); state.sessionTimer = null; } if ($('key-history')) $('key-history').value = ''; if ($('total-keys')) $('total-keys').textContent = '0'; if ($('session-time')) $('session-time').textContent = '00:00'; if ($('keys-tested')) $('keys-tested').textContent = `0/${TOTAL_KEYS}`; if ($('most-pressed')) $('most-pressed').textContent = '없음'; if ($('current-latency')) $('current-latency').textContent = '-- ms'; if ($('avg-latency')) $('avg-latency').textContent = '--'; if ($('min-latency')) $('min-latency').textContent = '--'; if ($('max-latency')) $('max-latency').textContent = '--'; $$('.key').forEach(k => { k.classList.remove('pressed', 'active-1', 'active-2', 'active-3', 'active-4', 'active-5'); const counter = k.querySelector('.key-counter'); if (counter) counter.remove(); }); $$('.indicator').forEach(i => i.classList.remove('active')); resetCatProgress(); }
...
if (!isset($GLOBALS['__kbt_adv_loaded'])) {
    ...
    echo "<script>window.KBT_LOCALE = 'ko';</script>";
