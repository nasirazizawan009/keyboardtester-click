<?php
if (empty($GLOBALS['kbtLocalizedModernCapturingLegacy'])) {
    require __DIR__ . '/../../includes/render-localized-modern-legacy-page.php';
    return;
}
/**
...
// Meta tags
$pageTitle = '키보드 테스트 - 온라인 한글 키보드 테스터 무료, 고스팅·지연 검사';
...
<head>
    ...
    <!-- Landing Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;600&family=Space+Grotesk:wght@400;500;600;700&family=Noto+Sans+KR:wght@400;500;600;700&display=swap" rel="stylesheet" media="(min-width: 769px)">
