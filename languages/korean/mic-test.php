...
$pageDescription = '무료 온라인 마이크 테스터로 마이크 입력 수준과 음질을 테스트하세요. 실시간 오디오 레벨 미터와 피크 감지 기능을 제공하며 설치 없이 브라우저에서 바로 이용하세요.';
...
<head>
  ...
  <link rel="alternate" hreflang="ko" href="<?php echo absoluteUrl('languages/korean/mic-test.php'); ?>">
