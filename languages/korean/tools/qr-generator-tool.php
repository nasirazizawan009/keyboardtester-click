<?php
// Korean QR Code Generator tool - QR 코드 생성기
?>
  ...
  <div class="kbt-tool-grid two">
    <div class="kbt-tool-card">
      ...
      <div class="kbt-tool-field">
        <label for="qr-text">텍스트 또는 URL</label>
        <textarea class="kbt-tool-textarea" id="qr-text" rows="4" placeholder="텍스트 또는 URL을 입력하세요"></textarea>
      </div>
      <div class="kbt-tool-field">
        <label for="qr-size">크기</label>
      ...
      <div class="kbt-tool-actions">
        <button class="kbt-tool-button primary" id="qr-generate">생성</button>
        <button class="kbt-tool-button ghost" id="qr-download">다운로드</button>
      </div>
    </div>
    <div class="kbt-tool-card">
      <h3>미리보기</h3>
      <div class="qr-output" id="qr-output">QR 코드 미리보기</div>
    </div>
  </div>
</div>
