...
<head>
  ...
  <link rel="alternate" hreflang="en" href="<?php echo absoluteUrl('tools/latency_checker.php'); ?>">
  <link rel="alternate" hreflang="ko" href="<?php echo absoluteUrl('languages/korean/latency-checker.php'); ?>">
  <link rel="alternate" hreflang="x-default" href="<?php echo absoluteUrl('tools/latency_checker.php'); ?>">
