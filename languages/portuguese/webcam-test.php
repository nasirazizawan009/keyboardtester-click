...
$pageDescription = 'Teste de webcam online: prévia ao vivo, detecção de resolução, informações do dispositivo e captura de fotos — sem instalação. Verifique antes de chamadas de vídeo.';
...
<head>
  ...
  <link rel="alternate" hreflang="en" href="<?php echo absoluteUrl('webcam-test.php'); ?>">
  <link rel="alternate" hreflang="pt" href="<?php echo absoluteUrl('languages/portuguese/webcam-test.php'); ?>">
  <link rel="alternate" hreflang="x-default" href="<?php echo absoluteUrl('webcam-test.php'); ?>">
...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    ...
    <?php $localizedClusterLanguage = 'portuguese'; $localizedClusterKey = 'webcam'; $localizedClusterCurrent = 'webcam-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
