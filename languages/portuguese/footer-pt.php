    ...
    <div class="footer-container">
        <div class="footer-section about-section">
            ...
            <div class="social-links">
                <a href="<?php echo $socialLinks['github']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Baixar no GitHub">
                ...
                <a href="<?php echo $socialLinks['gitlab']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Ver no GitLab">
                ...
                <a href="<?php echo $socialLinks['youtube']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Ver no YouTube">
                ...
                <a href="<?php echo $socialLinks['facebook']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Seguir no Facebook">
        ...
        <div class="footer-section">
            ...
            <ul class="footer-links">
                ...
                <li><a href="<?php echo url('languages/portuguese/polling-rate-test.php'); ?>">🖱️ Teste de Taxa de Polling</a></li>
                <li><a href="<?php echo url('languages/portuguese/refresh-rate-test.php'); ?>">🖥️ Teste de Taxa de Atualização</a></li>
                <li><a href="<?php echo url('languages/portuguese/color-test.php'); ?>">🎨 Teste de Cor do Monitor</a></li>
                <li><a href="<?php echo url('languages/portuguese/touch-screen-test.php'); ?>">👆 Teste de Tela Touch</a></li>
                <li><a href="<?php echo url('languages/portuguese/gamepad-test.php'); ?>">🎮 Teste de Gamepad</a></li>
            </ul>
        </div>
