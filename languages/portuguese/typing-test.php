...
<head>
  ...
  <link rel="alternate" hreflang="pt" href="<?php echo absoluteUrl('languages/portuguese/typing-test.php'); ?>">
    ...
    <section class="feature-band" aria-labelledby="feature-title-pt">
      <div class="container">
        <div class="section-head">
          <p class="section-kicker">Velocidade e Precisao de Digitacao</p>
          <h2 id="feature-title-pt">Medir PPM, Precisao e Ritmo de Digitacao</h2>
          <p class="section-lede">Pratique com um teste de digitacao no navegador e veja velocidade e precisao atualizar em tempo real.</p>
        </div>
        <div class="landing-feature-grid">
          <article class="landing-feature-card">
            <h3>Resultados instantaneos</h3>
            <p>Acompanhe a velocidade de digitacao com atualizacoes ao vivo.</p>
          </article>
          <article class="landing-feature-card">
            <h3>Medicao precisa</h3>
            <p>Veja as mudancas durante o teste em tempo real.</p>
          </article>
          <article class="landing-feature-card">
            <h3>Controles simples</h3>
            <p>Inicie, pare e reinicie em segundos.</p>
          </article>
          <article class="landing-feature-card">
            <h3>Testes repetidos</h3>
            <p>Compare multiplas sessoes rapidamente.</p>
          </article>
        </div>
      </div>
    </section>
