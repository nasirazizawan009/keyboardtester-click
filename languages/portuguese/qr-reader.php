...
$pageDescription = 'Leitor de QR code: faça upload de uma imagem com QR code e decodifique o conteúdo localmente no navegador. Sem câmera, sem uploads, privado e instantâneo.';
...
<head>
  ...
  <link rel="alternate" hreflang="en" href="<?php echo absoluteUrl('qr-reader.php'); ?>">
  <link rel="alternate" hreflang="pt" href="<?php echo absoluteUrl('languages/portuguese/qr-reader.php'); ?>">
  <link rel="alternate" hreflang="x-default" href="<?php echo absoluteUrl('qr-reader.php'); ?>">
...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    ...
    <?php $localizedClusterLanguage = 'portuguese'; $localizedClusterKey = 'qr-reader'; $localizedClusterCurrent = 'qr-reader'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
