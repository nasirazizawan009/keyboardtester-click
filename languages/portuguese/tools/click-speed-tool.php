...
<div class="click-tester-section">
    <div class="click-tester">
        <div class="duration-select">
            <label for="duration">Selecionar duração: </label>
            <select id="duration">
        ...
        <div class="info-area">
            <div class="info-box">Duração <span id="sel-dur">5s</span></div>
            <div class="info-box">Cliques <span id="cur-clicks">—</span></div>
            <div class="info-box">Tempo <span id="time-left">5s</span></div>
        </div>

        <!-- Click target -->
        <div class="click-area" id="click-area">Clique aqui para começar!</div>
        ...
        <div class="result-strip" id="result-strip" style="display:none">
            ...
            <div class="result-row">
                <span class="result-label">Cliques</span>
                <span class="result-val" id="res-clicks">—</span>
            </div>
            <p class="result-remark" id="res-remark"></p>
            <button class="new-test-btn" id="new-test-btn">Novo teste</button>
        </div>
        ...
        <div class="test-history" id="test-history" style="display:none">
            ...
            <table class="history-table">
                <thead><tr><th>#</th><th>Duração</th><th>Cliques</th><th>CPS</th></tr></thead>
...
(function () {
    ...
    function endTest() {
        ...
        clickArea.textContent = 'Teste concluído';

        resCps.textContent    = cps;
        resClicks.textContent = `${clickCount} em ${dur}s`;
    ...
    function resetToIdle() {
        ...
        clickArea.textContent = 'Clique aqui para começar!';
    ...
    function getRemark(cps) {
        if (cps > 14) return "Nível divino de clique borboleta. Você é humano?";
        if (cps > 10) return "Clique com vibração! Seu antebraço discorda.";
        if (cps > 7)  return "Acima da média — bom ritmo de jogo!";
        if (cps > 4)  return "Faixa normal. Ainda há espaço para melhorar!";
        return "Devagar — esquente esses dedos!";
    }
