<div class="game-container">
    ...
    <div class="game-options">
        ...
        <div class="option-group">
            <select class="game-select" id="trailSelect" onchange="setTrail(this.value)">
                ...
                <option value="snowflake">Floco de Neve</option>
                <option value="rocket">Foguete</option>
                <option value="rainbow">Arco-iris</option>
            </select>
            <button class="game-button" id="clearTrailBtn" onclick="clearTrail()">Limpar Rastro</button>
        </div>
    </div>
    ...
    <div id="help" class="game-help">
        <h3 class="game-help-title">Ajuda Rapida</h3>
        <p class="game-help-text">Mova o mouse na area de jogo para criar divertidos rastros de emojis. Escolha diferentes emojis no menu suspenso para mudar o tipo de rastro. Sua pontuacao aumenta com base no numero de rastros, seu tipo e padroes de movimento (circulos fechados ou zigue-zagues selvagens). Clique em "Limpar Rastro" para reiniciar e comecar de novo!</p>
    </div>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function clearTrail() {
            ...
            if (gameArea && trails) {
                trails = [];
                gameArea.innerHTML = '';
                document.getElementById('result').innerHTML = 'Rastro limpo! Comece novamente.';
            } else {
