<?php
// Ferramenta de teste de DPI / Sensibilidade do mouse (independente)
?>

<div class="kbt-tool kbt-dpi-tool" id="dpi-tool">
  <div class="kbt-tool-grid two">
    <div class="kbt-tool-card">
      <h3>Estimativa de DPI</h3>
      <p>Insira a distancia fisica que voce move seu mouse, depois arraste dentro da area de rastreamento.</p>
      <div class="kbt-tool-field">
        <label for="dpi-distance">Distancia percorrida</label>
      ...
      <div class="kbt-tool-actions">
        <button class="kbt-tool-button primary" id="dpi-start">Iniciar medicao</button>
        <button class="kbt-tool-button" id="dpi-reset">Reiniciar</button>
      </div>
    </div>
    <div class="kbt-tool-card">
      <h3>Area de rastreamento</h3>
      <div class="dpi-track" id="dpi-track" aria-label="Area de rastreamento de DPI">
        Arraste aqui enquanto mantem pressionado o botao do mouse.
      </div>
      <div class="kbt-tool-stats">
        <div class="kbt-tool-stat"><span>Pixels percorridos</span><strong id="dpi-pixels">0 px</strong></div>
