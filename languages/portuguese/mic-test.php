...
$pageDescription = 'Testador de microfone online: verifique entrada do mic, níveis e pico de volume antes de Zoom, Teams ou Discord. No navegador, sem cadastro nem gravação.';
...
<head>
  ...
  <link rel="alternate" hreflang="en" href="<?php echo absoluteUrl('mic-test.php'); ?>">
  <link rel="alternate" hreflang="pt" href="<?php echo absoluteUrl('languages/portuguese/mic-test.php'); ?>">
  <link rel="alternate" hreflang="x-default" href="<?php echo absoluteUrl('mic-test.php'); ?>">
