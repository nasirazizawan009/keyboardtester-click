...
$pageDescription = 'أداة OCR مجانية: استخرج النصوص من الصور ولقطات الشاشة والصور الممسوحة محليًا في المتصفح عبر Tesseract.js. بدون رفع البيانات إلى أي خادم، مع حماية الخصوصية.';
...
<head>
  ...
  <link rel="alternate" hreflang="ar" href="<?php echo absoluteUrl('languages/arabic/ocr-tool.php'); ?>">
