...
$pageDescription = 'اختبار كاميرا الويب عبر الإنترنت: معاينة مباشرة، اكتشاف الدقة، معلومات الجهاز، والتقاط لقطات — بدون تثبيت. تحقق من الكاميرا قبل Zoom وTeams وMeet وDiscord.';
...
<head>
  ...
  <link rel="alternate" hreflang="ar" href="<?php echo absoluteUrl('languages/arabic/webcam-test.php'); ?>">
