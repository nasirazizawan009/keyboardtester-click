...
<head>
  ...
  <noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;600&family=Space+Grotesk:wght@400;500;600;700&display=optional"></noscript>
    ...
    <style>
        ...
        /* Tools list - RTL fixes (direction handled by dir="rtl" on section) */
        .arabic-page .tools-list-section--unified .tool-card {
            padding: 20px 24px 20px 20px;
        }

        .arabic-page .tools-list-section--unified .tool-card--ranked::before {
            left: auto;
            right: 0;
            border-radius: 2px 0 0 2px;
        }

        .arabic-page .tools-list-section--unified .tool-card-link::after {
            content: '←';
        }

        .arabic-page .tools-list-section--unified .tools-filter-bar {
            direction: rtl;
        }
