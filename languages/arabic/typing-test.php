...
$pageDescription = 'اختبر سرعة الكتابة ومعرفة WPM والدقة مجاناً في المتصفح. تحقق من مهاراتك في الكتابة مع اختبارات متعددة ونتائج فورية تساعدك على التطور المستمر.';
...
<head>
  ...
  <link rel="alternate" hreflang="ar" href="<?php echo absoluteUrl('languages/arabic/typing-test.php'); ?>">
