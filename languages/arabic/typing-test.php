...
$pageDescription = 'اختبار سرعة الكتابة المجاني: قِس عدد الكلمات في الدقيقة والدقة والاتساق في جلسات مؤقتة. بدون تسجيل، في المتصفح مباشرة، ومناسب لجميع الأعمار.';
