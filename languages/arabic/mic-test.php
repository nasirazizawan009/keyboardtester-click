...
$pageDescription = 'أداة اختبار الميكروفون عبر الإنترنت: تحقق من إدخال الميكروفون والمستويات وذروة الصوت قبل Zoom أو Teams أو Discord. في المتصفح، بدون تسجيل أو رفع.';
...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    ...
    <?php $localizedClusterLanguage = 'arabic'; $localizedClusterKey = 'mic'; $localizedClusterCurrent = 'mic-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
