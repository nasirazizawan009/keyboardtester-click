...
$pageDescription = 'اكتشف النقرات الوهمية والنقر المزدوج غير المقصود في الماوس مجاناً في المتصفح. أداة دقيقة لتشخيص مشاكل الماوس واكتشاف أعطال مفاتيح التبديل فوراً دون تحميل.';
...
<head>
  ...
  <link rel="alternate" hreflang="ar" href="<?php echo absoluteUrl('languages/arabic/ghost-click.php'); ?>">
