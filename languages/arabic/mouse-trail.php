...
$pageDescription = 'أداة تصور أثر الماوس: راقب أنماط الحركة مع آثار ملونة على لوحة ملء الشاشة. اختبار سلاسة التتبع وسلوك المستشعر في المتصفح، بدون تثبيت.';
...
<head>
  ...
  <link rel="alternate" hreflang="ar" href="<?php echo absoluteUrl('languages/arabic/mouse-trail.php'); ?>">
