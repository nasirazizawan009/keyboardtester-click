...
<div class="kbt-tool dpi-v2" id="dpi-tool" dir="rtl">
  ...
  <div class="dpi-panel active" id="dpi-p-test" role="tabpanel">
    <div class="dpi-mode-row"><div class="dpi-mode-toggle"><button class="dpi-mode-btn active" data-mode="basic">أساسي</button><button class="dpi-mode-btn" data-mode="advanced">متقدم</button></div></div>
    <div class="dpi-grid">
      <div class="dpi-card">
        ...
        <div class="dpi-field"><label for="dpi-expected"><?php echo $dpi_strings['lbl_exp']; ?> <small><?php echo $dpi_strings['exp_hint']; ?></small></label><input class="dpi-input full" id="dpi-expected" type="number" min="100" max="32000" step="100" placeholder="مثل 800"></div>
        ...
        <p style="font-size:.74rem;color:var(--text-muted);margin-top:10px;line-height:1.8"><?php echo $dpi_strings['tip']; ?></p>
      </div>
      <div class="dpi-card">
  ...
  <div class="dpi-panel" id="dpi-p-edpi" role="tabpanel">
    <div class="dpi-grid">
      ...
      <div class="dpi-card">
        ...
        <tbody id="edpi-tbody">
          <tr data-min="0" data-max="400"><td>200–400</td><td>منخفض جداً</td><td>محترفو FPS</td></tr>
          <tr data-min="400" data-max="800"><td>400–800</td><td>منخفض</td><td>FPS التنافسي</td></tr>
          <tr data-min="800" data-max="1600"><td>800–1600</td><td>متوسط</td><td>الألعاب العامة</td></tr>
          <tr data-min="1600" data-max="3200"><td>1600–3200</td><td>مرتفع</td><td>MOBA / RTS</td></tr>
          <tr data-min="3200" data-max="999999"><td>3200+</td><td>مرتفع جداً</td><td>المكتب والتصميم</td></tr>
        </tbody></table>
      </div>
    </div>
    <p class="dpi-privacy"><?php echo $dpi_strings['privacy']; ?></p>
  ...
  <div class="dpi-panel" id="dpi-p-conv" role="tabpanel">
    <div class="dpi-grid">
      <div class="dpi-card">
        ...
        <div class="dpi-conv-result"><p class="dpi-conv-formula" id="conv-formula">sens_جديد = (400 × 2.0) / 800</p><div class="dpi-conv-val" id="conv-val">1.0000</div><p class="dpi-conv-sub"><?php echo $dpi_strings['conv_sub']; ?></p></div>
      </div>
      <div class="dpi-card">
...
<script>
(function(){
var S=<?php echo json_encode(['run_n'=>$dpi_strings['run_n'],'run_avg'=>$dpi_strings['run_avg'],'run_more'=>$dpi_strings['run_more'],'run_done'=>$dpi_strings['run_done'],'track_ready'=>$dpi_strings['track_ready'],'track_idle'=>$dpi_strings['track_idle'],'btn_start'=>$dpi_strings['btn_start'],'acc_exc'=>'ممتاز ✓','acc_good'=>'جيد ✓','acc_fair'=>'مقبول','acc_poor'=>'ضعيف']); ?>;
var MAX=5;
...
function updConv(){var od=parseFloat(cOd.value)||0,os=parseFloat(cOs.value)||0,nd=parseFloat(cNd.value)||0;if(od&&os&&nd){cFm.textContent='sens_جديد = ('+od+' x '+os+') / '+nd;cVl.textContent=((od*os)/nd).toFixed(4);}else{cVl.textContent='--';}}
