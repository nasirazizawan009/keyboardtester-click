...
$pageDescription = 'قياس زمن استجابة لوحة المفاتيح والماوس في المتصفح مجاناً. احصل على قراءات دقيقة بالميلي ثانية مع إحصائيات مفصلة للتأخير والجيتر لتحسين أداء الألعاب والعمل.';
...
<head>
  ...
  <link rel="alternate" hreflang="ar" href="<?php echo absoluteUrl('languages/arabic/latency-checker.php'); ?>">
