...
$pageDescription = 'اختبر حساسية الماوس وقياس DPI بدقة عالية في المتصفح مجاناً. تحقق من دقة تتبع المؤشر وحساسية الحركة واعرف قيمة DPI الفعلية لجهازك دون أي برامج إضافية.';
...
<head>
  ...
  <link rel="alternate" hreflang="ar" href="<?php echo absoluteUrl('languages/arabic/dpi-tester.php'); ?>">
