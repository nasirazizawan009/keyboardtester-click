    ...
    <div class="footer-container">
        ...
        <div class="footer-section about-section">
            ...
            <div class="social-links">
                <a href="<?php echo $socialLinks['github']; ?>" target="_blank" rel="noopener noreferrer" aria-label="تنزيل من GitHub">
                ...
                <a href="<?php echo $socialLinks['gitlab']; ?>" target="_blank" rel="noopener noreferrer" aria-label="عرض على GitLab">
                ...
                <a href="<?php echo $socialLinks['youtube']; ?>" target="_blank" rel="noopener noreferrer" aria-label="مشاهدة على YouTube">
                ...
                <a href="<?php echo $socialLinks['facebook']; ?>" target="_blank" rel="noopener noreferrer" aria-label="متابعة على Facebook">
        ...
        <div class="footer-section">
            ...
            <ul class="footer-links">
                ...
                <li><a href="<?php echo url('languages/arabic/polling-rate-test.php'); ?>">🖱️ اختبار معدل الاستطلاع</a></li>
                <li><a href="<?php echo url('languages/arabic/refresh-rate-test.php'); ?>">🖥️ اختبار معدل التحديث</a></li>
                <li><a href="<?php echo url('languages/arabic/color-test.php'); ?>">🎨 اختبار ألوان الشاشة</a></li>
                <li><a href="<?php echo url('languages/arabic/touch-screen-test.php'); ?>">👆 اختبار الشاشة اللمسية</a></li>
                <li><a href="<?php echo url('languages/arabic/gamepad-test.php'); ?>">🎮 اختبار وحدة التحكم</a></li>
                <li><a href="<?php echo url('whatsapp-link-generator.php'); ?>">رابط واتساب</a></li>
                <li><a href="<?php echo url('luckywheeltoolindex.php'); ?>">عجلة الحظ</a></li>
            </ul>
        </div>
