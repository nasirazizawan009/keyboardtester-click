        ...
        <div class="hero-visual">
            <div class="hero-shot hero-shot--video hero-yt-facade" data-yt-id="wVyAj-nrtnI" data-yt-title="KeyboardTester.click — أداة فحص لوحة المفاتيح" role="button" tabindex="0" aria-label="تشغيل الفيديو">
                <picture>
                    ...
                    <img class="hero-yt-thumb" src="<?php echo url("images/yt-thumbs/wVyAj-nrtnI.jpg"); ?>" alt="معاينة فيديو فاحص لوحة المفاتيح" width="480" height="270" loading="eager" fetchpriority="high" decoding="async">
                </picture>
