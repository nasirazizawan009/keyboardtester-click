<?php
// Deutsches QR-Code-Generator-Tool
?>

<div class="kbt-tool kbt-qr-tool" id="qr-generator-tool">
  <div class="kbt-tool-grid two">
    <div class="kbt-tool-card">
      <h3>QR-Code generieren</h3>
      <div class="kbt-tool-field">
        <label for="qr-text">Text oder URL</label>
        <textarea class="kbt-tool-textarea" id="qr-text" rows="4" placeholder="Geben Sie Text oder URL ein"></textarea>
      </div>
      <div class="kbt-tool-field">
        <label for="qr-size">Groesse</label>
      ...
      <div class="kbt-tool-actions">
        <button class="kbt-tool-button primary" id="qr-generate">Generieren</button>
        <button class="kbt-tool-button ghost" id="qr-download">Herunterladen</button>
      </div>
    </div>
    <div class="kbt-tool-card">
      <h3>Vorschau</h3>
      <div class="qr-output" id="qr-output">QR-Code-Vorschau</div>
    </div>
  </div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function renderQR() {
    ...
    if (!text) {
      output.textContent = 'QR-Code-Vorschau';
      return;
    }
