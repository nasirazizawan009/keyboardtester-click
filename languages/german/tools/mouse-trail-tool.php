<div class="game-container">
    ...
    <div id="help" class="game-help">
        <h3 class="game-help-title">Schnelle Hilfe</h3>
        <p class="game-help-text">Bewegen Sie die Maus im Spielbereich, um lustige Emoji-Spuren zu erstellen. Waehlen Sie verschiedene Emojis aus dem Dropdown-Menue, um den Spurtyp zu aendern. Ihre Punktzahl erhoeht sich basierend auf der Anzahl der Spuren, deren Typ und Bewegungsmuster (geschlossene Kreise oder wilde Zickzacks). Klicken Sie auf "Spur loeschen", um zurueckzusetzen und neu zu beginnen!</p>
    </div>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function clearTrail() {
            ...
            if (gameArea && trails) {
                trails = [];
                gameArea.innerHTML = '';
                document.getElementById('result').innerHTML = 'Spur geloescht! Beginnen Sie neu.';
            } else {
