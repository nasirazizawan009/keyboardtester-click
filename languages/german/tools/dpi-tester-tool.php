<?php
// Maus-DPI-Tester v2.0 — Deutsch
$dpi_strings = [
  'tab_test'=>'DPI-Test','tab_edpi'=>'eDPI-Rechner','tab_conv'=>'Konverter',
  'setup'=>'1 — Einrichtung','lbl_dist'=>'Physische Strecke, die Sie die Maus bewegen',
  'unit_cm'=>'cm','unit_in'=>'Zoll','lbl_exp'=>'Erwarteter DPI',
  'exp_hint'=>'(optional — aktiviert Abweichung und Genauigkeit)',
  'lbl_axis'=>'Messachse einschränken','axis_both'=>'Beliebige Richtung (empfohlen)',
  'axis_x'=>'Nur horizontal (X-Achse)','axis_y'=>'Nur vertikal (Y-Achse)',
  'btn_start'=>'▶ Messung starten','btn_reset'=>'Alles zurücksetzen',
  'tip'=>'<strong>Tipp:</strong> Legen Sie ein Lineal auf Ihr Mauspad, markieren Sie Anfang und Ende, dann ziehen Sie bei gedrückter Maustaste.',
  'track_lbl'=>'DPI-Tracking-Bereich','track_title'=>'2 — Tracking und Ergebnisse',
  'track_idle'=>'Starten klicken, dann hier ziehen',
  'track_ready'=>'Maustaste halten + über gemessene Strecke ziehen',
  'stat_px'=>'Pixel bewegt','stat_dpi'=>'Geschätzter DPI','stat_dev'=>'Abweichung','stat_acc'=>'Genauigkeit',
  'runs_lbl'=>'Messhistorie (für weitere ziehen)','run_n'=>'Messung','run_avg'=>'Ø:',
  'run_more'=>' von %d — erneut ziehen ↔','run_done'=>'Alle Messungen abgeschlossen',
  'privacy'=>'🔒 Dieser Test läuft vollständig in Ihrem Browser. Es werden keine Daten gesammelt.',
  'edpi_setup'=>'Ihre Einstellungen','lbl_dpi'=>'Maus-DPI','lbl_sens'=>'In-Game-Empfindlichkeit',
  'lbl_game'=>'Spiel (für Vergleich)','game_any'=>'— Beliebig / Benutzerdefiniert —',
  'edpi_lbl'=>'eDPI — Effektiver DPI','edpi_formula'=>'<strong>Formel:</strong> eDPI = Maus-DPI × In-Game-Empfindlichkeit',
  'pro_title'=>'Profi-Vergleich','pro_intro'=>'Ihr eDPI ist in der Tabelle hervorgehoben.',
  'pro_h1'=>'eDPI-Bereich','pro_h2'=>'Niveau','pro_h3'=>'Typisch für',
  'conv_curr'=>'Aktuelle Einstellungen','lbl_old_dpi'=>'Aktueller DPI',
  'lbl_old_s'=>'Aktuelle In-Game-Empfindlichkeit','conv_target'=>'Zieleinstellungen',
  'lbl_new_dpi'=>'Neuer DPI (nach Mauswechsel)',
  'conv_sub'=>'Neue Empfindlichkeit — gleiches Muskelgedächtnis, anderer DPI',
  'conv_how'=>'So funktioniert es',
  'conv_exp1'=>'Der Konverter hält Ihren <strong>eDPI konstant</strong>, sodass dieselbe physische Bewegung immer dieselbe In-Game-Ansicht erzeugt.',
  'conv_formula'=>'neue_sens = (alter_DPI × alte_sens) / neuer_DPI',
  'conv_exp2'=>'<strong>Beispiel:</strong> 400 DPI bei 2.0 Sens → 800 DPI bei 1.0 Sens. Beide haben eDPI 800.',
  'log_title'=>'Sitzungsprotokoll',
  'log_dl'=>'&#11015; Protokoll herunterladen (.txt)',
  'log_empty'=>'Noch keine Messungen. Führen Sie einen DPI-Test durch.',
];
?>
...
<div class="kbt-tool dpi-v2" id="dpi-tool">
  ...
  <div class="dpi-panel active" id="dpi-p-test" role="tabpanel">
    <div class="dpi-mode-row"><div class="dpi-mode-toggle"><button class="dpi-mode-btn active" data-mode="basic">Einfach</button><button class="dpi-mode-btn" data-mode="advanced">Erweitert</button></div></div>
    <div class="dpi-grid">
      <div class="dpi-card">
        ...
        <div class="dpi-field"><label for="dpi-expected"><?php echo $dpi_strings['lbl_exp']; ?> <small><?php echo $dpi_strings['exp_hint']; ?></small></label><input class="dpi-input full" id="dpi-expected" type="number" min="100" max="32000" step="100" placeholder="z.B. 800"></div>
  ...
  <div class="dpi-panel" id="dpi-p-edpi" role="tabpanel">
    <div class="dpi-grid">
      ...
      <div class="dpi-card">
        ...
        <tbody id="edpi-tbody">
          <tr data-min="0" data-max="400"><td>200–400</td><td>Sehr niedrig</td><td>Pro-FPS (S1mple)</td></tr>
          <tr data-min="400" data-max="800"><td>400–800</td><td>Niedrig</td><td>Kompetitives FPS</td></tr>
          <tr data-min="800" data-max="1600"><td>800–1600</td><td>Mittel</td><td>Allgemeines Gaming</td></tr>
          <tr data-min="1600" data-max="3200"><td>1600–3200</td><td>Hoch</td><td>MOBA / RTS</td></tr>
          <tr data-min="3200" data-max="999999"><td>3200+</td><td>Sehr hoch</td><td>Büro, Design</td></tr>
        </tbody></table>
      </div>
    </div>
    <p class="dpi-privacy"><?php echo $dpi_strings['privacy']; ?></p>
  ...
  <div class="dpi-panel" id="dpi-p-conv" role="tabpanel">
    <div class="dpi-grid">
      <div class="dpi-card">
        ...
        <div class="dpi-conv-result"><p class="dpi-conv-formula" id="conv-formula">neue_sens = (400 &times; 2.0) / 800</p><div class="dpi-conv-val" id="conv-val">1.0000</div><p class="dpi-conv-sub"><?php echo $dpi_strings['conv_sub']; ?></p></div>
      </div>
      <div class="dpi-card">
...
function updConv(){var od=parseFloat(cOd.value)||0,os=parseFloat(cOs.value)||0,nd=parseFloat(cNd.value)||0;if(od&&os&&nd){cFm.innerHTML='neue_sens = ('+od+' &times; '+os+') / '+nd;cVl.textContent=((od*os)/nd).toFixed(4);}else{cVl.textContent='--';}}
