...
<header class="site-header" id="siteHeader">
    ...
    <div class="mega-panel" id="toolsPanel">
        <div class="panel-inner">
            <div>
                <div class="panel-title"><span class="panel-title-icon">⌨️</span> Tastatur</div>
                <div class="panel-links">
                    ...
                    <a href="<?php echo url('languages/german/spacebar-test.php'); ?>">Leertasten-Test</a>
                    <a href="<?php echo url('languages/german/reaction-time-test.php'); ?>">Reaktionszeit-Test</a>
                    <a href="<?php echo url('keyboard-ghosting-test.php'); ?>">Ghosting-Test</a>
                    <a href="<?php echo url('n-key-rollover-test.php'); ?>">N-Key Rollover</a>
                    <a href="<?php echo url('stuck-key-test.php'); ?>">Hängende Taste</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🖱️</span> Maus</div>
                <div class="panel-links">
                    ...
                    <a href="<?php echo url('languages/german/mouse-trail.php'); ?>">Mausspur</a>
                    <a href="<?php echo url('languages/german/polling-rate-test.php'); ?>">Abfragerate-Test</a>
                    <a href="<?php echo url('scroll-wheel-test.php'); ?>">Scrollrad-Test</a>
                    <a href="<?php echo url('double-click-test.php'); ?>">Doppelklick-Test</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🖥️</span> Bildschirm</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['screen_test']; ?>">Bildschirm-Test</a>
                    <a href="<?php echo $pages['webcam_test']; ?>">Webcam-Test</a>
                    <a href="<?php echo url('languages/german/dead-pixel-test.php'); ?>">Toter Pixel</a>
                    <a href="<?php echo url('stuck-pixel-test.php'); ?>">Stuck-Pixel</a>
                    <a href="<?php echo url('black-screen-test.php'); ?>">Schwarzer Bildschirm</a>
                    <a href="<?php echo url('white-screen-test.php'); ?>">Weißer Bildschirm</a>
                    <a href="<?php echo url('languages/german/refresh-rate-test.php'); ?>">Bildwiederholrate</a>
                    <a href="<?php echo url('languages/german/color-test.php'); ?>">Farbtest</a>
                    <a href="<?php echo url('languages/german/touch-screen-test.php'); ?>">Touchscreen-Test</a>
                </div>
            </div>
            <div>
                ...
                <div class="panel-links">
                    ...
                    <a href="<?php echo url('microphone-volume-test.php'); ?>">Mikrofon-Lautstärke</a>
                    <a href="<?php echo url('left-right-speaker-test.php'); ?>">Lautsprecher L/R</a>
                    <a href="<?php echo url('stereo-test.php'); ?>">Stereo-Test</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🛠️</span> Hilfsprogramme</div>
                <div class="panel-links">
                    ...
                    <a href="<?php echo url('languages/german/gamepad-test.php'); ?>">Gamepad-Test</a>
                </div>
            </div>
        </div>
    </div>
