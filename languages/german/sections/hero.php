        ...
        <div class="process-grid">
            <article class="process-card">
                <div class="process-media">
                    ...
                    <img src="<?php echo url('images/keyboard/Press-any-key-512.png'); ?>" width="512" height="768" alt="Druecken Sie eine beliebige Taste zum Starten" loading="lazy" decoding="async">
                    </picture>
                </div>
            ...
            <article class="process-card">
                <div class="process-media">
                    ...
                    <img src="<?php echo url('images/keyboard/special-keys-layout-640.png'); ?>" width="640" height="426" alt="Sondertasten und Tastaturlayout" loading="lazy" decoding="async">
                    </picture>
                </div>
                <div class="process-body">
            ...
            <article class="process-card">
                <div class="process-media">
                    ...
                    <img src="<?php echo url('images/keyboard/color-system-guide-640.png'); ?>" width="640" height="426" alt="Farbsystem und exportierbare Ergebnisse" loading="lazy" decoding="async">
                    </picture>
                </div>
                <div class="process-body">
