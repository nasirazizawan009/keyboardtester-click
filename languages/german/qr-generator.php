...
$pageDescription = 'Kostenloser QR-Code-Generator: Erstellen Sie QR-Codes aus URLs, Text, Telefonnummern oder WhatsApp-Links. Download als hochauflösendes PNG, ohne Wasserzeichen oder Anmeldung.';
...
<head>
  ...
  <link rel="alternate" hreflang="en" href="<?php echo absoluteUrl('qr-generator.php'); ?>">
  <link rel="alternate" hreflang="de" href="<?php echo absoluteUrl('languages/german/qr-generator.php'); ?>">
  <link rel="alternate" hreflang="x-default" href="<?php echo absoluteUrl('qr-generator.php'); ?>">
