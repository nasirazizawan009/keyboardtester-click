...
<footer class="site-footer">
    <div class="footer-container">
        <div class="footer-section about-section">
            ...
            <p class="footer-description">Moderne Testwerkzeuge fuer Tastaturen, Maeuse, Audio, Bildschirme und mehr, entwickelt fuer Klarheit, Praezision und Geschwindigkeit.</p>
            <div class="social-links">
                <a href="<?php echo $socialLinks['github']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Auf GitHub herunterladen">
                ...
                <a href="<?php echo $socialLinks['gitlab']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Auf GitLab ansehen">
                ...
                <a href="<?php echo $socialLinks['youtube']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Auf YouTube ansehen">
                ...
                <a href="<?php echo $socialLinks['facebook']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Auf Facebook folgen">
        ...
        <div class="footer-section">
            <h4 class="footer-heading">Schnelllinks</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">Startseite</a></li>
                <li><a href="<?php echo $pages['blog']; ?>">Blog</a></li>
                <li><a href="<?php echo $pages['about']; ?>">Ueber uns</a></li>
                <li><a href="<?php echo $pages['privacy']; ?>">Datenschutz</a></li>
                <li><a href="<?php echo $pages['disclaimer']; ?>">Haftungsausschluss</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">Testwerkzeuge</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">Tastatur-Tester</a></li>
                <li><a href="<?php echo $pages['mouse_test']; ?>">Maus-Tester</a></li>
                <li><a href="<?php echo $pages['keyboard_typing']; ?>">Geschwindigkeitstest</a></li>
                <li><a href="<?php echo $pages['screen_test']; ?>">Bildschirm-Tester</a></li>
                <li><a href="<?php echo $pages['mic_test']; ?>">Mikrofon-Tester</a></li>
                <li><a href="<?php echo $pages['webcam_test']; ?>">Webcam-Tester</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">Weitere Werkzeuge</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['qr_generator']; ?>">QR-Generator</a></li>
                <li><a href="<?php echo $pages['ocr_tool']; ?>">OCR-Werkzeug</a></li>
                <li><a href="<?php echo $pages['password_gen']; ?>">Passwort-Generator</a></li>
                <li><a href="<?php echo $pages['ghost_click']; ?>">Geisterklick-Detektor</a></li>
                <li><a href="<?php echo url('languages/german/polling-rate-test.php'); ?>">🖱️ Maus-Abfragerate-Test</a></li>
                <li><a href="<?php echo url('languages/german/refresh-rate-test.php'); ?>">🖥️ Bildwiederholrate-Test</a></li>
                <li><a href="<?php echo url('languages/german/color-test.php'); ?>">🎨 Monitor-Farbtest</a></li>
                <li><a href="<?php echo url('languages/german/touch-screen-test.php'); ?>">👆 Touchscreen-Test</a></li>
                <li><a href="<?php echo url('languages/german/gamepad-test.php'); ?>">🎮 Gamepad-Test</a></li>
            </ul>
        </div>
        <div class="footer-section contact-section">
            <h4 class="footer-heading">Bleiben Sie verbunden</h4>
            ...
            <div class="newsletter">
                <p>Erhalten Sie Updates zu neuen Werkzeugen</p>
    ...
    <div class="footer-bottom">
        <p class="copyright">&copy; <?php echo $siteYear; ?> <a href="<?php echo $pages['home']; ?>"><?php echo $siteName; ?></a>. Alle Rechte vorbehalten.</p>
        <p class="tagline">Mit <span class="heart">❤️</span> gemacht fuer Technikbegeisterte weltweit</p>
    </div>
</footer>
<button id="back-to-top" class="back-to-top" aria-label="Nach oben">↑</button>
