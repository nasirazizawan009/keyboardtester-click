...
$pageDescription = 'Тестер DPI и чувствительности мыши: проверяет реальное разрешение сенсора, точность отслеживания и постоянство курсора. В браузере, без драйверов.';
...
<head>
  ...
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/dpi-tester.php'); ?>">
...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    ...
    <section class="tool-stage" aria-labelledby="tool-stage-title">
      ...
      <section id="dpi-shell" class="tool-shell">
