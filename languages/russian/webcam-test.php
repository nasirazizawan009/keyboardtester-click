...
$pageDescription = 'Проверьте веб-камеру бесплатно онлайн. Протестируйте качество видео, разрешение и настройки камеры прямо в браузере — без установки программ и без регистрации.';
...
<head>
  ...
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/webcam-test.php'); ?>">
