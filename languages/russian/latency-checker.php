...
$pageDescription = 'Измерьте задержку ввода клавиатуры и мыши в реальном времени. Точные данные в миллисекундах, среднее время отклика и статистика джиттера — оптимизируйте игровой процесс бесплатно.';
...
<head>
  ...
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/latency-checker.php'); ?>">
