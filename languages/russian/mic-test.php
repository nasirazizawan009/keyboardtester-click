...
$pageDescription = 'Онлайн-тестер микрофона: проверка входа мик., уровней и пикового звука перед Zoom, Teams или Discord. В браузере, без регистрации и без записи аудио.';
...
<head>
  ...
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/mic-test.php'); ?>">
...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    ...
    <?php $localizedClusterLanguage = 'russian'; $localizedClusterKey = 'mic'; $localizedClusterCurrent = 'mic-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
    <?php $localizedClusterLanguage = 'russian'; $localizedClusterKey = 'mic'; $localizedClusterCurrent = 'mic-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
