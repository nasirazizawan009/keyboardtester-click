...
$pageDescription = 'Бесплатный тест скорости печати: измеряйте WPM (слова в минуту), точность и стабильность в таймированных сессиях. Без регистрации, прямо в браузере.';
    ...
    <section class="feature-band" aria-labelledby="feature-title-ru">
      <div class="container">
        <div class="section-head">
          <p class="section-kicker">Скорость и Точность Печати</p>
          <h2 id="feature-title-ru">Измерение WPM, Точности и Ритма Печати</h2>
          <p class="section-lede">Практикуйтесь с браузерным тестом и наблюдайте за скоростью и точностью в реальном времени.</p>
        </div>
        <div class="landing-feature-grid">
          <article class="landing-feature-card">
            <h3>Мгновенные результаты</h3>
            <p>Отслеживайте скорость печати с обновлениями в реальном времени.</p>
          </article>
          <article class="landing-feature-card">
            <h3>Точное измерение</h3>
            <p>Видьте изменения во время теста в реальном времени.</p>
          </article>
          <article class="landing-feature-card">
            <h3>Простое управление</h3>
            <p>Запускайте, останавливайте и сбрасывайте за секунды.</p>
          </article>
          <article class="landing-feature-card">
            <h3>Повторяемые тесты</h3>
            <p>Быстро сравнивайте несколько попыток.</p>
          </article>
        </div>
      </div>
    </section>
