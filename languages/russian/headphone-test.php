...
$pageDescription = 'Тестер наушников и колонок: проверяет левый/правый каналы, стерео-разделение и аудиовывод. В браузере, без установки и записи, мгновенный результат.';
...
<head>
  ...
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/headphone-test.php'); ?>">
