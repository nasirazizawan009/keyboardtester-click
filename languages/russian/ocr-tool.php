...
$pageDescription = 'Бесплатный OCR-инструмент: извлекает текст из изображений, скриншотов и фото локально в браузере через Tesseract.js. Без загрузки на сервер, с защитой приватности.';
...
<head>
  ...
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/ocr-tool.php'); ?>">
