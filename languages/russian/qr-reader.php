...
$pageDescription = 'Сканер QR-кодов: загрузите изображение с QR-кодом и декодируйте содержимое локально в браузере. Без камеры, без загрузки на сервер, приватно и мгновенно.';
...
<head>
  ...
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/qr-reader.php'); ?>">
