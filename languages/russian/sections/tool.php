...
<section class="keyboard-tester" id="keyboard-tester">
    <div class="controls-wrapper">
        <div class="textarea-wrapper">
            <div class="textarea-label">История клавиш</div>
            <textarea class="text-box" id="key-history" rows="4" placeholder="Нажмите любую клавишу для начала теста..."></textarea>
        </div>
    ...
    <div class="feature-controls" id="feature-controls" style="display: none;">
        ...
        <button class="feature-button" id="sound-button">
            ...
            <span class="sound-label">Звук: Выкл</span>
        </button>
    ...
    <div class="stats-panel" id="stats-panel" style="display: none;">
        <div class="stats-header">
            <h3><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 20V10M12 20V4M6 20v-6"/></svg> Статистика сессии</h3>
            <button class="close-btn" id="close-stats">&times;</button>
        </div>
        <div class="stats-content">
            <div class="stat-item"><span class="stat-label">Всего нажатий</span><span class="stat-value" id="total-keys">0</span></div>
            <div class="stat-item"><span class="stat-label">Время сессии</span><span class="stat-value" id="session-time">00:00</span></div>
            <div class="stat-item"><span class="stat-label">Протестировано клавиш</span><span class="stat-value" id="keys-tested">0/104</span></div>
            <div class="stat-item"><span class="stat-label">Самая частая</span><span class="stat-value" id="most-pressed">Нет</span></div>
        </div>
    </div>

    <div class="stats-panel" id="latency-panel" style="display: none;">
        <div class="stats-header">
            <h3><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg> Тест задержки</h3>
            <button class="close-btn" id="close-latency">&times;</button>
        </div>
        <div class="stats-content">
            <div class="stat-item latency-display">
                <div id="current-latency" class="big-latency">-- мс</div>
                <div class="latency-sublabel">Текущая задержка</div>
            </div>
            <div class="latency-grid">
                <div class="stat-item compact"><span class="stat-value mono" id="avg-latency">--</span><span class="stat-label">Средняя</span></div>
                <div class="stat-item compact"><span class="stat-value mono" id="min-latency">--</span><span class="stat-label">Лучшая</span></div>
                <div class="stat-item compact"><span class="stat-value mono" id="max-latency">--</span><span class="stat-label">Худшая</span></div>
            </div>
        </div>
    </div>
    ...
    <div class="keyboard-container">
        ...
        <div class="keyboard-layout">
            <div class="keyboard-section main-keyboard">
                ...
                <!-- Number Row -->
                <div class="key-row">
                    <button class="key" data-key="Backquote"><span class="dual">Ё<br>`</span></button>
                ...
                <div class="key-row">
                    ...
                    <button class="key" data-key="KeyQ"><span class="dual-ru">Й<br><small>Q</small></span></button>
                    <button class="key" data-key="KeyW"><span class="dual-ru">Ц<br><small>W</small></span></button>
                    <button class="key" data-key="KeyE"><span class="dual-ru">У<br><small>E</small></span></button>
                    <button class="key" data-key="KeyR"><span class="dual-ru">К<br><small>R</small></span></button>
                    <button class="key" data-key="KeyT"><span class="dual-ru">Е<br><small>T</small></span></button>
                    <button class="key" data-key="KeyY"><span class="dual-ru">Н<br><small>Y</small></span></button>
                    <button class="key" data-key="KeyU"><span class="dual-ru">Г<br><small>U</small></span></button>
                    <button class="key" data-key="KeyI"><span class="dual-ru">Ш<br><small>I</small></span></button>
                    <button class="key" data-key="KeyO"><span class="dual-ru">Щ<br><small>O</small></span></button>
                    <button class="key" data-key="KeyP"><span class="dual-ru">З<br><small>P</small></span></button>
                    <button class="key" data-key="BracketLeft"><span class="dual-ru">Х<br><small>[</small></span></button>
                    <button class="key" data-key="BracketRight"><span class="dual-ru">Ъ<br><small>]</small></span></button>
                ...
                <div class="key-row">
                    ...
                    <button class="key" data-key="KeyA"><span class="dual-ru">Ф<br><small>A</small></span></button>
                    <button class="key" data-key="KeyS"><span class="dual-ru">Ы<br><small>S</small></span></button>
                    <button class="key" data-key="KeyD"><span class="dual-ru">В<br><small>D</small></span></button>
                    <button class="key" data-key="KeyF"><span class="dual-ru">А<br><small>F</small></span></button>
                    <button class="key" data-key="KeyG"><span class="dual-ru">П<br><small>G</small></span></button>
                    <button class="key" data-key="KeyH"><span class="dual-ru">Р<br><small>H</small></span></button>
                    <button class="key" data-key="KeyJ"><span class="dual-ru">О<br><small>J</small></span></button>
                    <button class="key" data-key="KeyK"><span class="dual-ru">Л<br><small>K</small></span></button>
                    <button class="key" data-key="KeyL"><span class="dual-ru">Д<br><small>L</small></span></button>
                    <button class="key" data-key="Semicolon"><span class="dual-ru">Ж<br><small>;</small></span></button>
                    <button class="key" data-key="Quote"><span class="dual-ru">Э<br><small>'</small></span></button>
                ...
                <div class="key-row">
                    ...
                    <button class="key" data-key="KeyZ"><span class="dual-ru">Я<br><small>Z</small></span></button>
                    <button class="key" data-key="KeyX"><span class="dual-ru">Ч<br><small>X</small></span></button>
                    <button class="key" data-key="KeyC"><span class="dual-ru">С<br><small>C</small></span></button>
                    <button class="key" data-key="KeyV"><span class="dual-ru">М<br><small>V</small></span></button>
                    <button class="key" data-key="KeyB"><span class="dual-ru">И<br><small>B</small></span></button>
                    <button class="key" data-key="KeyN"><span class="dual-ru">Т<br><small>N</small></span></button>
                    <button class="key" data-key="KeyM"><span class="dual-ru">Ь<br><small>M</small></span></button>
                    <button class="key" data-key="Comma"><span class="dual-ru">Б<br><small>,</small></span></button>
                    <button class="key" data-key="Period"><span class="dual-ru">Ю<br><small>.</small></span></button>
                ...
                <div class="key-row">
                    ...
                    <button class="key key-space" data-key="Space"><span>Пробел</span></button>
                    ...
                    <button class="key key-1-25x" data-key="ContextMenu"><span>Меню</span></button>
            ...
            <div class="keyboard-section numpad-section">
                <div class="indicator-panel">
                    ...
                    <div class="indicator" id="scroll-indicator"><div class="led" id="scroll-led"></div><span>Scroll</span></div>
                </div>
...
.key .dual-ru { font-size: 13px; line-height: 1.1; text-align: center; font-weight: 700; }
.key .dual-ru small { font-size: 8px; color: var(--text-muted); font-weight: 500; display: block; margin-top: 2px; }
...
(function() {
    ...
    if (soundButton) soundButton.addEventListener('click', () => { state.soundEnabled = !state.soundEnabled; soundButton.classList.toggle('active', state.soundEnabled); soundButton.querySelector('.sound-label').textContent = state.soundEnabled ? 'Звук: Вкл' : 'Звук: Выкл'; });
