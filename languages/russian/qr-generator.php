...
$pageDescription = 'Создайте QR-код для текста, ссылок, номеров телефонов и контактов бесплатно. Настройте размер, просматривайте результат в реальном времени и скачайте в формате PNG.';
...
<head>
  ...
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/qr-generator.php'); ?>">
