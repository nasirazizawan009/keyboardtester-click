...
<header class="site-header" id="siteHeader">
    <div class="header-container">
        <a href="<?php echo $pages['home']; ?>" class="brand">
            <img src="<?php echo url('images/shared/logo.svg'); ?>" alt="KeyboardTester логотип" width="32" height="32" loading="eager" decoding="async" fetchpriority="high">
        ...
        <nav class="site-nav" id="siteNav">
            <a class="nav-link" href="<?php echo $pages['home']; ?>">Главная</a>
            <button class="nav-link" id="toolsToggle">Инструменты</button>
            <a class="nav-link" href="<?php echo $pages['privacy']; ?>">Конфиденциальность</a>
            <a class="nav-link" href="<?php echo $pages['about']; ?>">О нас</a>
            <div class="nav-actions">
                <div class="lang-selector" id="langSelector">
                    <button class="lang-toggle" id="langToggle">🌐 <span>RU</span></button>
                    <div class="lang-dropdown" id="langDropdown">
                        ...
                        <a href="<?php echo url('languages/russian/'); ?>" class="lang-option active"><span class="lang-flag">🇷🇺</span>Русский</a>
                ...
                <a href="<?php echo $pages['home']; ?>#tools" class="cta-btn">Попробовать</a>
            </div>
        </nav>
    </div>
