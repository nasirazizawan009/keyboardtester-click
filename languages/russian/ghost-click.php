...
$pageDescription = 'Детектор ghost click: диагностирует непреднамеренные двойные клики и дребезг переключателя изношенной мыши. Живой журнал, без установки, с защитой приватности.';
...
<head>
  ...
  <link rel="alternate" hreflang="en" href="<?php echo absoluteUrl('ghost-click-detector.php'); ?>">
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/ghost-click.php'); ?>">
  <link rel="alternate" hreflang="x-default" href="<?php echo absoluteUrl('ghost-click-detector.php'); ?>">
