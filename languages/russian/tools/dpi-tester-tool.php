...
<div class="kbt-tool dpi-v2" id="dpi-tool">
  ...
  <div class="dpi-panel active" id="dpi-p-test" role="tabpanel">
    <div class="dpi-mode-row"><div class="dpi-mode-toggle"><button class="dpi-mode-btn active" data-mode="basic">Базовый</button><button class="dpi-mode-btn" data-mode="advanced">Расширенный</button></div></div>
    <div class="dpi-grid">
      <div class="dpi-card">
        ...
        <div class="dpi-field"><label for="dpi-expected"><?php echo $dpi_strings['lbl_exp']; ?> <small><?php echo $dpi_strings['exp_hint']; ?></small></label><input class="dpi-input full" id="dpi-expected" type="number" min="100" max="32000" step="100" placeholder="напр. 800"></div>
  ...
  <div class="dpi-panel" id="dpi-p-edpi" role="tabpanel">
    <div class="dpi-grid">
      ...
      <div class="dpi-card">
        ...
        <tbody id="edpi-tbody">
          <tr data-min="0"    data-max="400">   <td>200–400</td>  <td>Очень низкая</td> <td>Про FPS (S1mple, sh1ro)</td></tr>
          <tr data-min="400"  data-max="800">   <td>400–800</td>  <td>Низкая</td>       <td>Турнирный FPS / Valorant</td></tr>
          <tr data-min="800"  data-max="1600">  <td>800–1600</td> <td>Средняя</td>      <td>Обычные геймеры, казуальный FPS</td></tr>
          <tr data-min="1600" data-max="3200">  <td>1600–3200</td><td>Высокая</td>      <td>MOBA / RTS</td></tr>
          <tr data-min="3200" data-max="999999"><td>3200+</td>    <td>Очень высокая</td><td>Офис, дизайн</td></tr>
        </tbody></table>
      </div>
    </div>
    <p class="dpi-privacy"><?php echo $dpi_strings['privacy']; ?></p>
  ...
  <div class="dpi-panel" id="dpi-p-conv" role="tabpanel">
    <div class="dpi-grid">
      <div class="dpi-card">
        ...
        <div class="dpi-conv-result">
          <p class="dpi-conv-formula" id="conv-formula">новая_чув = (400 &times; 2.0) / 800</p>
          <div class="dpi-conv-val" id="conv-val">1.0000</div>
          <p class="dpi-conv-sub"><?php echo $dpi_strings['conv_sub']; ?></p>
        </div>
      </div>
      <div class="dpi-card">
...
<script>
(function(){
var S = <?php echo json_encode([
  'run_n'       => $dpi_strings['run_n'],
  'run_avg'     => $dpi_strings['run_avg'],
  'run_more'    => $dpi_strings['run_more'],
  'run_done'    => $dpi_strings['run_done'],
  'track_ready' => $dpi_strings['track_ready'],
  'track_idle'  => $dpi_strings['track_idle'],
  'btn_start'   => $dpi_strings['btn_start'],
  'measuring'   => '⏺ ...',
]); ?>;
var MAX=5;
...
function accuracy(p){if(p<=2)return{label:'\u041e\u0442\u043b\u0438\u0447\u043d\u043e \u2713',cls:'s-good'};if(p<=5)return{label:'\u0425\u043e\u0440\u043e\u0448\u043e \u2713',cls:'s-good'};if(p<=10)return{label:'\u0423\u0434\u043e\u0432\u043b',cls:'s-warn'};return{label:'\u041f\u043b\u043e\u0445\u043e',cls:'s-bad'};}
...
function updConv(){var od=parseFloat(cOd.value)||0,os=parseFloat(cOs.value)||0,nd=parseFloat(cNd.value)||0;if(od&&os&&nd){cFm.innerHTML='\u043d\u043e\u0432\u0430\u044f_\u0447\u0443\u0432 = ('+od+' &times; '+os+') / '+nd;cVl.textContent=((od*os)/nd).toFixed(4);}else{cVl.textContent='--';}}
