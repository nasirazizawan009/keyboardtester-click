<?php
// Russian DPI Tester Tool - Тестер DPI Мыши
?>
...
<div class="kbt-tool kbt-dpi-tool" id="dpi-tool">
  <div class="kbt-tool-grid two">
    <div class="kbt-tool-card">
      <h3>Оценка DPI</h3>
      <p>Введите физическое расстояние, на которое вы двигаете мышь, затем перетащите в области отслеживания.</p>
      <div class="kbt-tool-field">
        <label for="dpi-distance">Пройденное расстояние</label>
      ...
      <div class="kbt-tool-actions">
        <button class="kbt-tool-button primary" id="dpi-start">Начать измерение</button>
        <button class="kbt-tool-button" id="dpi-reset">Сбросить</button>
      </div>
    </div>
    <div class="kbt-tool-card">
      <h3>Область отслеживания</h3>
      <div class="dpi-track" id="dpi-track" aria-label="Область отслеживания DPI">
        Перетащите здесь, удерживая кнопку мыши.
      </div>
      <div class="kbt-tool-stats">
        <div class="kbt-tool-stat"><span>Пройдено пикселей</span><strong id="dpi-pixels">0 px</strong></div>
        <div class="kbt-tool-stat"><span>Расчетный DPI</span><strong id="dpi-result">--</strong></div>
      </div>
    </div>
  </div>
</div>
