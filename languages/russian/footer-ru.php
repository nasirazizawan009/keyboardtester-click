...
<footer class="site-footer">
    <div class="footer-container">
        <div class="footer-section about-section">
            ...
            <p class="footer-description">Современные инструменты тестирования для клавиатур, мышей, аудио, экранов и многого другого, разработанные для точности, ясности и скорости.</p>
            <div class="social-links">
                <a href="<?php echo $socialLinks['github']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Скачать на GitHub">
                ...
                <a href="<?php echo $socialLinks['gitlab']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Посмотреть на GitLab">
                ...
                <a href="<?php echo $socialLinks['youtube']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Смотреть на YouTube">
                ...
                <a href="<?php echo $socialLinks['facebook']; ?>" target="_blank" rel="noopener noreferrer" aria-label="Подписаться на Facebook">
        ...
        <div class="footer-section">
            ...
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">Главная</a></li>
                <li><a href="<?php echo $pages['blog']; ?>">Блог</a></li>
                <li><a href="<?php echo $pages['about']; ?>">О нас</a></li>
                <li><a href="<?php echo $pages['privacy']; ?>">Конфиденциальность</a></li>
                <li><a href="<?php echo $pages['disclaimer']; ?>">Отказ от ответственности</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">Инструменты тестирования</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">Тестер клавиатуры</a></li>
                <li><a href="<?php echo $pages['mouse_test']; ?>">Тестер мыши</a></li>
                <li><a href="<?php echo $pages['keyboard_typing']; ?>">Тест скорости печати</a></li>
                <li><a href="<?php echo $pages['screen_test']; ?>">Тестер экрана</a></li>
                <li><a href="<?php echo $pages['mic_test']; ?>">Тестер микрофона</a></li>
                <li><a href="<?php echo $pages['webcam_test']; ?>">Тестер веб-камеры</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">Дополнительные инструменты</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['qr_generator']; ?>">Генератор QR</a></li>
                <li><a href="<?php echo $pages['ocr_tool']; ?>">OCR инструмент</a></li>
                <li><a href="<?php echo $pages['password_gen']; ?>">Генератор паролей</a></li>
                <li><a href="<?php echo $pages['ghost_click']; ?>">Детектор призрачных кликов</a></li>
                <li><a href="<?php echo url('languages/russian/polling-rate-test.php'); ?>">🖱️ Тест частоты опроса мыши</a></li>
                <li><a href="<?php echo url('languages/russian/refresh-rate-test.php'); ?>">🖥️ Тест частоты обновления</a></li>
                <li><a href="<?php echo url('languages/russian/color-test.php'); ?>">🎨 Тест цветов монитора</a></li>
                <li><a href="<?php echo url('languages/russian/touch-screen-test.php'); ?>">👆 Тест сенсорного экрана</a></li>
                <li><a href="<?php echo url('languages/russian/gamepad-test.php'); ?>">🎮 Тест геймпада</a></li>
            </ul>
        </div>
        <div class="footer-section contact-section">
            <h4 class="footer-heading">Оставайтесь на связи</h4>
            ...
            <div class="newsletter">
                <p>Получайте обновления о новых инструментах</p>
    ...
    <div class="footer-bottom">
        <p class="copyright">&copy; <?php echo $siteYear; ?> <a href="<?php echo $pages['home']; ?>"><?php echo $siteName; ?></a>. Все права защищены.</p>
        <p class="tagline">Сделано с <span class="heart">❤️</span> для технических энтузиастов по всему миру</p>
    </div>
</footer>
