...
$pageDescription = 'Визуализатор следа мыши: наблюдайте паттерны движения с цветными следами на полноэкранном холсте. Проверяет плавность трекинга и поведение сенсора, без установки.';
...
<head>
  ...
  <link rel="alternate" hreflang="ru" href="<?php echo absoluteUrl('languages/russian/mouse-trail.php'); ?>">
