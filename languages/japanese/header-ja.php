...
<header class="site-header" id="siteHeader">
    <div class="header-container">
        <a href="<?php echo $pages['home']; ?>" class="brand">
            <img src="<?php echo url('images/shared/logo.svg'); ?>" alt="KeyboardTester ロゴ" width="32" height="32" loading="eager" decoding="async" fetchpriority="high">
            KeyboardTester<span>.click</span>
        </a>
        <button class="menu-toggle" id="menuToggle" aria-label="メニュー切替">
            <span></span><span></span><span></span>
        </button>
        <nav class="site-nav" id="siteNav">
            <a class="nav-link" href="<?php echo $pages['home']; ?>">ホーム</a>
            <button class="nav-link" id="toolsToggle">ツール</button>
            <a class="nav-link" href="<?php echo $pages['privacy']; ?>">プライバシー</a>
            <a class="nav-link" href="<?php echo $pages['about']; ?>">概要</a>
            <div class="nav-actions">
                <div class="lang-selector" id="langSelector">
                    <button class="lang-toggle" id="langToggle">🌐 <span>JA</span></button>
                    <div class="lang-dropdown" id="langDropdown">
                        ...
                        <a href="<?php echo url('languages/japanese/'); ?>" class="lang-option active"><span class="lang-flag">🇯🇵</span>日本語</a>
                ...
                <a href="<?php echo $pages['home']; ?>#tools" class="cta-btn">ツールを試す</a>
            </div>
        </nav>
    </div>
    <div class="mega-panel" id="toolsPanel">
        <div class="panel-inner">
            <div>
                <div class="panel-title"><span class="panel-title-icon">⌨️</span> キーボード</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['home']; ?>">キーボードテスター</a>
                    <a href="<?php echo $pages['keyboard_typing']; ?>">タイピングテスト</a>
                    <a href="<?php echo $pages['latency_check']; ?>">レイテンシーチェッカー</a>
                    <a href="<?php echo url('languages/japanese/spacebar-test.php'); ?>">スペースバーテスト</a>
                    <a href="<?php echo url('languages/japanese/reaction-time-test.php'); ?>">反応時間テスト</a>
                    <a href="<?php echo url('keyboard-ghosting-test.php'); ?>">ゴーストキーテスト</a>
                    <a href="<?php echo url('n-key-rollover-test.php'); ?>">Nキーロールオーバー</a>
                    <a href="<?php echo url('stuck-key-test.php'); ?>">スタックキーテスト</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🖱️</span> マウス</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['mouse_test']; ?>">マウステスター</a>
                    <a href="<?php echo $pages['click_speed']; ?>">クリック速度テスト</a>
                    <a href="<?php echo $pages['ghost_click']; ?>">ゴーストクリック検出</a>
                    <a href="<?php echo $pages['dpi_tester']; ?>">DPIテスト</a>
                    <a href="<?php echo url('languages/japanese/mouse-trail.php'); ?>">マウストレイル</a>
                    <a href="<?php echo url('languages/japanese/polling-rate-test.php'); ?>">ポーリングレート</a>
                    <a href="<?php echo url('scroll-wheel-test.php'); ?>">スクロールテスト</a>
                    <a href="<?php echo url('double-click-test.php'); ?>">ダブルクリック</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🖥️</span> 画面</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['screen_test']; ?>">画面テスト</a>
                    <a href="<?php echo $pages['webcam_test']; ?>">ウェブカメラテスト</a>
                    <a href="<?php echo url('languages/japanese/dead-pixel-test.php'); ?>">デッドピクセル</a>
                    <a href="<?php echo url('stuck-pixel-test.php'); ?>">スタックピクセル</a>
                    <a href="<?php echo url('black-screen-test.php'); ?>">黒い画面テスト</a>
                    <a href="<?php echo url('white-screen-test.php'); ?>">白い画面テスト</a>
                    <a href="<?php echo url('languages/japanese/refresh-rate-test.php'); ?>">リフレッシュレート</a>
                    <a href="<?php echo url('languages/japanese/color-test.php'); ?>">カラーテスト</a>
                    <a href="<?php echo url('languages/japanese/touch-screen-test.php'); ?>">タッチスクリーン</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🎧</span> オーディオ</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['mic_test']; ?>">マイクテスト</a>
                    <a href="<?php echo $pages['headphone_test']; ?>">ヘッドフォンテスト</a>
                    <a href="<?php echo url('microphone-volume-test.php'); ?>">マイク音量テスト</a>
                    <a href="<?php echo url('left-right-speaker-test.php'); ?>">スピーカー左右テスト</a>
                    <a href="<?php echo url('stereo-test.php'); ?>">ステレオテスト</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🛠️</span> ユーティリティ</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['qr_generator']; ?>">QRコード生成</a>
                    <a href="<?php echo $pages['qr_reader']; ?>">QRコード読取</a>
                    <a href="<?php echo $pages['ocr_tool']; ?>">OCRツール</a>
                    <a href="<?php echo $pages['password_gen']; ?>">パスワード生成</a>
                    <a href="<?php echo url('languages/japanese/gamepad-test.php'); ?>">ゲームパッドテスト</a>
                </div>
            </div>
        </div>
    </div>
