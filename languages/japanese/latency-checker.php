...
$pageDescription = 'マウスとキーボードの入力遅延（レイテンシー）をリアルタイムで測定。ミリ秒単位の精密データと平均応答時間、ジッター統計でゲームや作業のパフォーマンスを最適化。';
...
<head>
  ...
  <link rel="alternate" hreflang="ja" href="<?php echo absoluteUrl('languages/japanese/latency-checker.php'); ?>">
