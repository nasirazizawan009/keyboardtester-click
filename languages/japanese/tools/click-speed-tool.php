...
<div class="click-tester-section">
    <div class="click-tester">
        ...
        <div class="info-area">
            <div class="info-box">時間 <span id="sel-dur">5s</span></div>
            <div class="info-box">クリック <span id="cur-clicks">—</span></div>
            <div class="info-box">残り <span id="time-left">5s</span></div>
        </div>
        ...
        <div class="result-strip" id="result-strip" style="display:none">
            ...
            <div class="result-row">
                <span class="result-label">クリック</span>
        ...
        <div class="test-history" id="test-history" style="display:none">
            ...
            <table class="history-table">
                <thead><tr><th>#</th><th>時間</th><th>クリック</th><th>CPS</th></tr></thead>
...
(function () {
    ...
    function startTest() {
        ...
        clickArea.textContent     = 'クリックし続けて！';
    ...
    function endTest() {
        ...
        clickArea.textContent = 'テスト終了';

        resCps.textContent    = cps;
        resClicks.textContent = `${clickCount} (${dur}秒)`;
    ...
    function getRemark(cps) {
        if (cps > 14) return "バタフライクリックの神レベル。本当に人間ですか？";
        if (cps > 10) return "ジッタークリック！あなたの前腕は反対しています。";
        if (cps > 7)  return "平均以上 — 素晴らしいゲームペースです！";
        if (cps > 4)  return "平均的な範囲。まだ伸びしろがあります！";
        return "ゆっくりで大丈夫 — 指を温めましょう！";
    }
