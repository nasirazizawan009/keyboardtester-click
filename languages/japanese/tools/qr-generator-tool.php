<?php
// Japanese QR Code Generator Tool - QRコード生成器
?>
  ...
  <div class="kbt-tool-grid two">
    <div class="kbt-tool-card">
      ...
      <div class="kbt-tool-field">
        ...
        <textarea class="kbt-tool-textarea" id="qr-text" rows="4" placeholder="テキストまたはURLを入力"></textarea>
      </div>
      <div class="kbt-tool-field">
      ...
      <div class="kbt-tool-actions">
        <button class="kbt-tool-button primary" id="qr-generate">生成</button>
        <button class="kbt-tool-button ghost" id="qr-download">ダウンロード</button>
      </div>
    </div>
    <div class="kbt-tool-card">
      <h3>プレビュー</h3>
      <div class="qr-output" id="qr-output">QRコードプレビュー</div>
    </div>
  </div>
</div>
