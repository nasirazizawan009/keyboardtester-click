...
<head>
  ...
  <link rel="alternate" hreflang="ja" href="<?php echo absoluteUrl('languages/japanese/screen-test.php'); ?>">
...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    ...
    <?php $localizedClusterLanguage = 'japanese'; $localizedClusterKey = 'screen'; $localizedClusterCurrent = 'screen-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
    <?php $localizedClusterLanguage = 'japanese'; $localizedClusterKey = 'screen'; $localizedClusterCurrent = 'screen-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
