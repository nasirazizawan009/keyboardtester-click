...
$pageDescription = 'ウェブカメラの動作、画質、解像度、設定をオンラインで無料テスト。インストール不要でブラウザから直接カメラを確認でき、リアルタイムのフィードバックを提供します。';
...
<head>
  ...
  <link rel="alternate" hreflang="en" href="<?php echo absoluteUrl('webcamtesterindex.php'); ?>">
  <link rel="alternate" hreflang="ja" href="<?php echo absoluteUrl('languages/japanese/webcam-test.php'); ?>">
  <link rel="alternate" hreflang="x-default" href="<?php echo absoluteUrl('webcamtesterindex.php'); ?>">
...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    ...
    <?php $localizedClusterLanguage = 'japanese'; $localizedClusterKey = 'webcam'; $localizedClusterCurrent = 'webcam-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
    <?php $localizedClusterLanguage = 'japanese'; $localizedClusterKey = 'webcam'; $localizedClusterCurrent = 'webcam-test'; include __DIR__ . '/../../includes/components/localized-intent-links.php'; ?>
