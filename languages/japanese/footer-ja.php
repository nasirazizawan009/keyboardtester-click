...
<footer class="site-footer">
    <div class="footer-container">
        ...
        <div class="footer-section">
            <h4 class="footer-heading">クイックリンク</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">ホーム</a></li>
                <li><a href="<?php echo $pages['blog']; ?>">ブログ</a></li>
                <li><a href="<?php echo $pages['about']; ?>">概要</a></li>
                <li><a href="<?php echo $pages['privacy']; ?>">プライバシー</a></li>
                <li><a href="<?php echo $pages['disclaimer']; ?>">免責事項</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">テストツール</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['home']; ?>">キーボードテスター</a></li>
                <li><a href="<?php echo $pages['mouse_test']; ?>">マウステスター</a></li>
                <li><a href="<?php echo $pages['keyboard_typing']; ?>">タイピングテスト</a></li>
                <li><a href="<?php echo $pages['screen_test']; ?>">画面テスター</a></li>
                <li><a href="<?php echo $pages['mic_test']; ?>">マイクテスター</a></li>
                <li><a href="<?php echo $pages['webcam_test']; ?>">ウェブカメラテスター</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4 class="footer-heading">その他のツール</h4>
            <ul class="footer-links">
                <li><a href="<?php echo $pages['qr_generator']; ?>">QRコード生成</a></li>
    ...
    <div class="footer-bottom">
        <p class="copyright">&copy; <?php echo $siteYear; ?> <a href="<?php echo $pages['home']; ?>"><?php echo $siteName; ?></a>. All rights reserved.</p>
        <p class="tagline">世界中のテクノロジー愛好家のために <span class="heart">❤️</span> を込めて作成</p>
    </div>
</footer>
<button id="back-to-top" class="back-to-top" aria-label="トップに戻る">↑</button>

<style>
.site-footer { --footer-bg: #0b1220; --footer-surface: rgba(15, 23, 42, 0.78); --footer-border: rgba(148, 163, 184, 0.18); --footer-accent: #38bdf8; --footer-text: #e2e8f0; --footer-muted: #94a3b8; background: radial-gradient(900px 320px at 10% 0%, rgba(56, 189, 248, 0.16), transparent 60%), radial-gradient(700px 280px at 90% 20%, rgba(14, 165, 233, 0.14), transparent 60%), var(--footer-bg); color: var(--footer-text); padding: 80px 20px 28px; font-family: 'Noto Sans JP', 'Inter', sans-serif; margin-top: 90px; border-top: 1px solid var(--footer-border); }
