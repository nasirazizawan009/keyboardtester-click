...
<section class="landing-hero">
    <div class="container landing-hero-grid">
        ...
        <div class="hero-visual">
            <div class="hero-shot hero-shot--video hero-yt-facade" data-yt-id="wVyAj-nrtnI" data-yt-title="KeyboardTester.click — キーボードテスター" role="button" tabindex="0" aria-label="動画を再生">
                <picture>
                    <source type="image/webp" srcset="<?php echo url("images/yt-thumbs/wVyAj-nrtnI.webp"); ?>">
                    <img class="hero-yt-thumb" src="<?php echo url("images/yt-thumbs/wVyAj-nrtnI.jpg"); ?>" alt="キーボードテスター動画プレビュー" width="480" height="270" loading="eager" fetchpriority="high" decoding="async">
                </picture>
        ...
        <div class="process-grid">
            <article class="process-card">
                <div class="process-media">
                    ...
                    <img src="<?php echo url('images/keyboard/Press-any-key-512.png'); ?>" width="512" height="768" alt="任意のキーを押してテスト開始" loading="lazy" decoding="async">
                    </picture>
                </div>
            ...
            <article class="process-card">
                <div class="process-media">
                    ...
                    <img src="<?php echo url('images/keyboard/special-keys-layout-640.png'); ?>" width="640" height="426" alt="特殊キーとキーボードレイアウト" loading="lazy" decoding="async">
                    </picture>
                </div>
                <div class="process-body">
            ...
            <article class="process-card">
                <div class="process-media">
                    ...
                    <img src="<?php echo url('images/keyboard/color-system-guide-640.png'); ?>" width="640" height="426" alt="カラーシステムとエクスポート結果" loading="lazy" decoding="async">
                    </picture>
                </div>
                <div class="process-body">
