...
@media (max-width: 992px) {
    .keyboard-container { padding: 20px 16px; overflow-x: auto; -webkit-overflow-scrolling: touch; }
    .keyboard-layout { flex-wrap: nowrap; min-width: max-content; justify-content: flex-start; }
