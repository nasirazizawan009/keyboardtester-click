...
$pageDescription = 'マウスのすべてのボタン、スクロールホイール、カーソル移動をリアルタイムでテスト。クリック精度を確認し、マウスの問題を即座に検出できる無料ブラウザツールです。';
...
<head>
  ...
  <link rel="alternate" hreflang="ja" href="<?php echo absoluteUrl('languages/japanese/mouse-test.php'); ?>">
