...
$pageDescription = 'Detector de ghost click: diagnostica dobles clics involuntarios y rebote de switch en ratones desgastados. Registro en vivo, sin instalación, privacidad garantizada.';
...
<head>
  ...
  <link rel="alternate" hreflang="en" href="<?php echo absoluteUrl('ghost-click-test.php'); ?>">
  <link rel="alternate" hreflang="es" href="<?php echo absoluteUrl('languages/spanish/ghost-click.php'); ?>">
  <link rel="alternate" hreflang="x-default" href="<?php echo absoluteUrl('ghost-click-test.php'); ?>">
