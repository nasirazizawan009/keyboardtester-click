<?php
// Spanish QR Code Generator tool - Generador de Códigos QR
?>
  ...
  <div class="kbt-tool-grid two">
    <div class="kbt-tool-card">
      ...
      <div class="kbt-tool-field">
        ...
        <textarea class="kbt-tool-textarea" id="qr-text" rows="4" placeholder="Ingresa texto o URL"></textarea>
      </div>
      <div class="kbt-tool-field">
      ...
      <div class="kbt-tool-actions">
        <button class="kbt-tool-button primary" id="qr-generate">Generar</button>
        <button class="kbt-tool-button ghost" id="qr-download">Descargar</button>
      </div>
    </div>
    <div class="kbt-tool-card">
      <h3>Vista previa</h3>
      <div class="qr-output" id="qr-output">Vista previa del código QR</div>
    </div>
  </div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function renderQR() {
    ...
    if (!text) {
      output.textContent = 'Vista previa del código QR';
      return;
    }
