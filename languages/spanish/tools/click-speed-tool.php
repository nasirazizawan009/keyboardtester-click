...
<div class="click-tester-section">
    <div class="click-tester">
        <div class="duration-select">
            <label for="duration">Seleccionar duracion de la prueba: </label>
            <select id="duration">
        ...
        <div class="info-area">
            <div class="info-box" id="duration-box">⏱️ Duracion: <span id="selected-duration">1s</span></div>
            <div class="info-box" id="clicks-box">👆 Clics: <span id="current-clicks">0</span></div>
            <div class="info-box" id="time-left-box">⏳ Tiempo restante: <span id="time-left">0s</span></div>
        </div>
        <div class="click-area" id="click-area">Haz clic aqui para comenzar! 🚀</div>
        <button class="reset-button" id="reset-button">Reiniciar</button>
        <div class="result-popup" id="result-popup">
            <h2>Tu resultado 🎉</h2>
            <p id="cpm-result"></p>
            <p id="funny-remark"></p>
            <button id="close-result">Intentar de nuevo</button>
        </div>
    </div>
</div>
...
<script>
    ...
    function endTest() {
        ...
        clickArea.textContent = 'Haz clic aqui para comenzar! 🚀';

        cpmResult.textContent = `Tu CPM: ${cpm} 🎯`;
    ...
    function getFunnyRemark(cpm) {
        if (cpm > 300) return "Guau, eres un Guepardo con esteroides! 🐆⚡";
        if (cpm > 200) return "Rapido como un Halcon, buen clic! 🦅💨";
        if (cpm > 100) return "Eres un Conejo veloz, sigue asi! 🐇🏃";
        if (cpm > 50) return "Velocidad de Tortuga, pero la constancia gana! 🐢👍";
        return "Ritmo de Caracol! Hasta un Perezoso se reiria! 🐌😂";
    }
