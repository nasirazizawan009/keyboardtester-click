...
<div class="click-tester-section">
    <div class="click-tester">
        <div class="duration-select">
            <label for="duration">Seleccionar duración: </label>
            <select id="duration">
        ...
        <div class="info-area">
            <div class="info-box">Duración <span id="sel-dur">5s</span></div>
            <div class="info-box">Clics <span id="cur-clicks">—</span></div>
            <div class="info-box">Tiempo <span id="time-left">5s</span></div>
        </div>

        <!-- Click target -->
        <div class="click-area" id="click-area">¡Haz clic aquí para comenzar!</div>
        ...
        <div class="result-strip" id="result-strip" style="display:none">
            ...
            <div class="result-row">
                <span class="result-label">Clics</span>
                <span class="result-val" id="res-clicks">—</span>
            </div>
            <p class="result-remark" id="res-remark"></p>
            <button class="new-test-btn" id="new-test-btn">Nueva prueba</button>
        </div>
        ...
        <div class="test-history" id="test-history" style="display:none">
            <div class="history-header">
                <span>Historial</span>
                <button id="clear-history">Borrar</button>
            </div>
            <table class="history-table">
                <thead><tr><th>#</th><th>Duración</th><th>Clics</th><th>CPS</th></tr></thead>
...
(function () {
    ...
    clickArea.addEventListener('click', () => {
        ...
        // 'done' state: click area ignores clicks
    });
    ...
    function resetToIdle() {
        ...
        clickArea.textContent = '¡Haz clic aquí para comenzar!';
    ...
    function getRemark(cps) {
        if (cps > 14) return "Dios del clic mariposa. ¿Eres humano?";
        if (cps > 10) return "¡Clic con vibración! Tu antebrazo no está de acuerdo.";
        if (cps > 7)  return "Por encima de la media — ¡buen ritmo de juego!";
        if (cps > 4)  return "Rango normal. ¡Hay margen de mejora!";
        return "Con calma — ¡calienta esos dedos!";
    }
