...
<head>
  ...
  <link rel="alternate" hreflang="es" href="<?php echo absoluteUrl('languages/spanish/typing-test.php'); ?>">
    ...
    <section class="feature-band" aria-labelledby="feature-title-es">
      <div class="container">
        <div class="section-head">
          <p class="section-kicker">Velocidad y Precision de Escritura</p>
          <h2 id="feature-title-es">Medir PPM, Precision y Ritmo de Escritura</h2>
          <p class="section-lede">Practica con una prueba de escritura en el navegador y ve la velocidad y precision actualizarse en tiempo real.</p>
        </div>
        <div class="landing-feature-grid">
          <article class="landing-feature-card">
            <h3>Resultados instantaneos</h3>
            <p>Sigue la velocidad de escritura con actualizaciones en vivo.</p>
          </article>
          <article class="landing-feature-card">
            <h3>Medicion precisa</h3>
            <p>Ve los cambios durante la prueba en tiempo real.</p>
          </article>
          <article class="landing-feature-card">
            <h3>Controles simples</h3>
            <p>Empieza, para y reinicia en segundos.</p>
          </article>
          <article class="landing-feature-card">
            <h3>Pruebas repetibles</h3>
            <p>Compara multiples sesiones rapidamente.</p>
          </article>
        </div>
      </div>
    </section>
