...
<header class="site-header" id="siteHeader">
    <div class="header-container">
        ...
        <nav class="site-nav" id="siteNav">
            ...
            <button class="nav-link" id="toolsToggle">Herramientas</button>
            <a class="nav-link" href="<?php echo $pages['privacy']; ?>">Privacidad</a>
            <a class="nav-link" href="<?php echo $pages['about']; ?>">Acerca de</a>
            <div class="nav-actions">
                <div class="lang-selector" id="langSelector">
                    <button class="lang-toggle" id="langToggle">🌐 <span>ES</span></button>
                    <div class="lang-dropdown" id="langDropdown">
                        ...
                        <a href="<?php echo url('languages/spanish/'); ?>" class="lang-option active"><span class="lang-flag">🇪🇸</span>Español</a>
                ...
                <a href="<?php echo $pages['home']; ?>#tools" class="cta-btn">Probar Herramientas</a>
            </div>
        </nav>
    </div>
        ...
        <div class="panel-inner">
            <div>
                ...
                <div class="panel-links">
                    <a href="<?php echo $pages['home']; ?>">Probador de Teclado</a>
                    <a href="<?php echo $pages['keyboard_typing']; ?>">Test de Velocidad</a>
                    <a href="<?php echo $pages['latency_check']; ?>">Verificador de Latencia</a>
                    <a href="<?php echo url('languages/spanish/spacebar-test.php'); ?>">Test de Barra Espaciadora</a>
                    <a href="<?php echo url('languages/spanish/reaction-time-test.php'); ?>">Tiempo de Reacción</a>
                    <a href="<?php echo url('keyboard-ghosting-test.php'); ?>">Test de Ghosting</a>
                    <a href="<?php echo url('n-key-rollover-test.php'); ?>">N-Key Rollover</a>
                    <a href="<?php echo url('stuck-key-test.php'); ?>">Tecla Atascada</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🖱️</span> Ratón</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['mouse_test']; ?>">Probador de Ratón</a>
                    <a href="<?php echo $pages['click_speed']; ?>">Test de Velocidad de Clic</a>
                    <a href="<?php echo $pages['ghost_click']; ?>">Detector de Clics Fantasma</a>
                    <a href="<?php echo $pages['dpi_tester']; ?>">Test de DPI</a>
                    <a href="<?php echo url('languages/spanish/mouse-trail.php'); ?>">Estela del Ratón</a>
                    <a href="<?php echo url('languages/spanish/polling-rate-test.php'); ?>">Test de Sondeo</a>
                    <a href="<?php echo url('scroll-wheel-test.php'); ?>">Rueda de Desplazamiento</a>
                    <a href="<?php echo url('double-click-test.php'); ?>">Test de Doble Clic</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🖥️</span> Pantalla</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['screen_test']; ?>">Test de Pantalla</a>
                    <a href="<?php echo $pages['webcam_test']; ?>">Test de Webcam</a>
                    <a href="<?php echo url('languages/spanish/dead-pixel-test.php'); ?>">Píxel Muerto</a>
                    <a href="<?php echo url('stuck-pixel-test.php'); ?>">Píxel Atascado</a>
                    <a href="<?php echo url('black-screen-test.php'); ?>">Pantalla Negra</a>
                    <a href="<?php echo url('white-screen-test.php'); ?>">Pantalla Blanca</a>
                    <a href="<?php echo url('languages/spanish/refresh-rate-test.php'); ?>">Test de Refresco</a>
                    <a href="<?php echo url('languages/spanish/color-test.php'); ?>">Test de Color</a>
                    <a href="<?php echo url('languages/spanish/touch-screen-test.php'); ?>">Pantalla Táctil</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🎧</span> Audio</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['mic_test']; ?>">Test de Micrófono</a>
                    <a href="<?php echo $pages['headphone_test']; ?>">Test de Auriculares</a>
                    <a href="<?php echo url('microphone-volume-test.php'); ?>">Volumen de Micrófono</a>
                    <a href="<?php echo url('left-right-speaker-test.php'); ?>">Altavoz Izq/Der</a>
                    <a href="<?php echo url('stereo-test.php'); ?>">Test Estéreo</a>
                </div>
            </div>
            <div>
                <div class="panel-title"><span class="panel-title-icon">🛠️</span> Utilidades</div>
                <div class="panel-links">
                    <a href="<?php echo $pages['qr_generator']; ?>">Generador QR</a>
                    <a href="<?php echo $pages['qr_reader']; ?>">Lector QR</a>
                    <a href="<?php echo $pages['ocr_tool']; ?>">Herramienta OCR</a>
                    <a href="<?php echo $pages['password_gen']; ?>">Generador de Contraseñas</a>
                    <a href="<?php echo url('languages/spanish/gamepad-test.php'); ?>">Test de Mando</a>
                </div>
            </div>
        </div>
    </div>
