...
<section class="landing-hero">
    <div class="container landing-hero-grid">
        ...
        <div class="hero-visual">
            <div class="hero-shot hero-shot--video hero-yt-facade" data-yt-id="wVyAj-nrtnI" data-yt-title="KeyboardTester.click — Probador de teclado" role="button" tabindex="0" aria-label="Reproducir video">
                <picture>
                    <source type="image/webp" srcset="<?php echo url("images/yt-thumbs/wVyAj-nrtnI.webp"); ?>">
                    <img class="hero-yt-thumb" src="<?php echo url("images/yt-thumbs/wVyAj-nrtnI.jpg"); ?>" alt="Vista previa del video del probador de teclado" width="480" height="270" loading="eager" fetchpriority="high" decoding="async">
                </picture>
        ...
        <div class="process-grid">
            <article class="process-card">
                <div class="process-media">
                    ...
                    <img src="<?php echo url('images/keyboard/Press-any-key-512.png'); ?>" width="512" height="768" alt="Presiona cualquier tecla para iniciar la prueba" loading="lazy" decoding="async">
                    </picture>
                </div>
            ...
            <article class="process-card">
                <div class="process-media">
                    ...
                    <img src="<?php echo url('images/keyboard/special-keys-layout-640.png'); ?>" width="640" height="426" alt="Teclas especiales y diseño de teclado" loading="lazy" decoding="async">
                    </picture>
                </div>
                <div class="process-body">
            ...
            <article class="process-card">
                <div class="process-media">
                    ...
                    <img src="<?php echo url('images/keyboard/color-system-guide-640.png'); ?>" width="640" height="426" alt="Sistema de colores y resultados exportables" loading="lazy" decoding="async">
                    </picture>
                </div>
                <div class="process-body">
