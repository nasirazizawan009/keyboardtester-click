        ...
        <div class="process-grid">
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/typing-test/step-1.svg'); ?>" alt="Start the test" loading="lazy">
            </div>
          ...
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/typing-test/step-2.svg'); ?>" alt="Type the prompt" loading="lazy">
            </div>
          ...
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/typing-test/step-3.svg'); ?>" alt="Review results" loading="lazy">
            </div>
