...
<body class="landing-page">
  ...
  <main id="main-content" class="landing-main">
    <?php include 'help/brief-whatsapp-brand-link-generator.php'; ?>
    ...
    <section class="trust-strip" aria-label="Key benefits">
      <div class="container trust-grid">
        ...
        <div class="trust-item">
          ...
          <div class="trust-desc">Built for branded links</div>
        </div>
      </div>
    </section>
    ...
    <section class="feature-band" aria-labelledby="feature-title">
      <div class="container">
        <div class="section-head">
          <p class="section-kicker">Branded Links</p>
          <h2 id="feature-title">Everything you need for whatsapp brand links</h2>
          <p class="section-lede">Run focused checks and confirm results in seconds.</p>
        </div>
        <div class="landing-feature-grid">
          <article class="landing-feature-card">
            <h3>Focused insights</h3>
            <p>Track branded links with live updates.</p>
          </article>
          <article class="landing-feature-card">
      ...
      <div class="container">
        <div class="section-head split">
          <div>
            ...
            <h2 id="process-title">Three steps to run the whatsapp brand links</h2>
          </div>
        ...
        <div class="process-grid">
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/whatsapp-brand/step-1.svg'); ?>" alt="Start the test" loading="lazy">
            </div>
          ...
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/whatsapp-brand/step-2.svg'); ?>" alt="Enter brand info" loading="lazy">
            </div>
            <div class="step-number">02</div>
            <h3>Enter brand info</h3>
            <p>to generate link and QR.</p>
          </article>
          <article class="process-card">
            <div class="process-media">
              <img src="<?php echo url('images/whatsapp-brand/step-3.svg'); ?>" alt="Review results" loading="lazy">
            </div>
            <div class="step-number">03</div>
            <h3>Review results</h3>
            <p>Check your branded links stats and retest if needed.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section class="tool-stage" aria-labelledby="tool-stage-title">
      <div class="container tool-stage-header">
        <div>
          ...
          <h2 id="tool-stage-title">WhatsApp Brand Links</h2>
      ...
      <section id="whatsapp-brand-link-generator" class="tool-shell">
        <?php include 'tools/whatsapp_brand_link_generator_tool.php'; ?>
      </section>
    </section>

    <?php include 'includes/components/tools-list.php'; ?>
    <?php include 'help/whatsapp-brand-link-generator.php'; ?>
  </main>
