<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>Ghost Click Detector Guide</h2>
    <p>Quick steps to run the ghost click detector and review your ghost clicks results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Click normally to detect unexpected double clicks.</li>
