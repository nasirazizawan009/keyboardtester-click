<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>Mouse Speed Test Guide</h2>
    <p>Quick steps to run the mouse speed test and review your click speed results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Click as fast as possible inside the test area.</li>
