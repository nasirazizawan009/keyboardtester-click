<section class="landing-hero">
  <div class="container landing-hero-grid">
    <div class="hero-copy">
      ...
      <h1 class="hero-title">Free Open Source Click Speed Test - Measure Your CPS Online</h1>
    ...
    <div class="hero-visual">
      <div class="hero-shot">
        <img src="<?php echo url('images/mouse-speed/hero.png'); ?>" alt="Mouse click speed test - measure CPS clicks per second online" loading="eager" width="800" height="534" decoding="async" fetchpriority="high">
      </div>
      <div class="hero-stack">
        <div class="mini-card">
          <div class="mini-title">Focused testing</div>
          <p>Run quick checks tailored for click speed.</p>
        </div>
        <div class="mini-card">
