<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>WhatsApp Sentiment Analyzer Guide</h2>
    <p>Quick steps to run the whatsapp sentiment analyzer and review your sentiment results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Paste chat text to analyze tone.</li>
