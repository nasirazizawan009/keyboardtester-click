<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>WhatsApp Link Generator Guide</h2>
    <p>Quick steps to run the whatsapp link generator and review your WhatsApp link results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Enter phone and message to build a link.</li>
