<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>WhatsApp Brand Links Guide</h2>
    <p>Quick steps to run the whatsapp brand links and review your branded links results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Enter brand info to generate link and QR.</li>
