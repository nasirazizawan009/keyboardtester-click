<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>Typing Speed Test Guide</h2>
    <p>Quick steps to run the typing speed test and review your typing speed results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Type the prompt until the timer ends.</li>
