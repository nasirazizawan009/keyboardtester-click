<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>Webcam Tester Guide</h2>
    <p>Quick steps to run the webcam tester and review your webcam quality results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Allow camera access and check the preview.</li>
