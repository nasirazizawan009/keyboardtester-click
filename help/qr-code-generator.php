<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>QR Code Generator Guide</h2>
    <p>Quick steps to run the qr code generator and review your QR creation results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Enter your data to generate a QR code.</li>
