<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>Latency Checker Guide</h2>
    <p>Quick steps to run the latency checker and review your input latency results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Press keys or click to measure response time.</li>
