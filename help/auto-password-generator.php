<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>Password Generator Guide</h2>
    <p>Quick steps to run the password generator and review your password strength results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Choose options to generate a password.</li>
