<section class="landing-hero">
  <div class="container landing-hero-grid">
    ...
    <div class="hero-visual">
      <div class="hero-shot">
        <img src="<?php echo url('images/whatsapp-sentiment/hero.svg'); ?>" alt="WhatsApp Sentiment Analyzer preview" loading="eager">
      </div>
      <div class="hero-stack">
        <div class="mini-card">
          <div class="mini-title">Focused testing</div>
          <p>Run quick checks tailored for sentiment.</p>
        </div>
        <div class="mini-card">
