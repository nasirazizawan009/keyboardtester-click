<section class="guidelines landing-guide" id="guidelines">
  <div class="help-header">
    <h2>Headphone & Speaker Tester Guide</h2>
    <p>Quick steps to run the headphone & speaker tester and review your audio output results.</p>
  </div>
  ...
  <div class="help-grid">
    <div class="help-card">
      ...
      <ol>
        ...
        <li>Play test audio to check channels.</li>
