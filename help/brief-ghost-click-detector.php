<section class="landing-hero">
  <div class="container landing-hero-grid">
    <div class="hero-copy">
      ...
      <h1 class="hero-title">Free Open Source Ghost Click Detector - Test Mouse Double Click Issues</h1>
    ...
    <div class="hero-visual">
      <div class="hero-shot">
        <img src="<?php echo url('images/ghost-click/hero.png'); ?>" alt="Ghost click detector tool - detect mouse double click and phantom click issues" loading="eager" width="800" height="460" decoding="async" fetchpriority="high">
      </div>
      <div class="hero-stack">
        <div class="mini-card">
          <div class="mini-title">Focused testing</div>
          <p>Run quick checks tailored for ghost clicks.</p>
        </div>
        <div class="mini-card">
